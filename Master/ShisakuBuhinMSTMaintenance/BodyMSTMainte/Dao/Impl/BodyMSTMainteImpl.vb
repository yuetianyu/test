...
Namespace ShisakuBuhinMSTMaintenance.BodyMSTMainte.Dao.Impl
    ...
    Public Class BodyMSTMainteImpl
        ...
        ''' </remarks>
        Public Function SelectBodyList(ByVal aArg As Dao.Vo.BodyMSTMainteVO) As List(Of Dao.Vo.BodyMSTMainteVO)
            ...
            Return db.QueryForList(Of Dao.Vo.BodyMSTMainteVO)(sb.ToString, aArg)
        End Function
            ...
            Using db As New EBomDbClient
                ...
                For Each lInsertRec In paramVo
                    ...
                    With sb
                        ...
                        .AppendLine("       ,@BlockNo")
                        .AppendLine("       ,@BuhinNo")
                        .AppendLine("       ,@XvlFileName")
                        .AppendLine("       ,@CadDataEventKbn")
                        .AppendLine("       ,@CadKaiteiNo")
