Namespace YosanBuhinEdit.Logic.Detect
    ...
    Public Interface DetectLatestStructure
        ...
        Function Compute(ByVal buhinNo As String, _
                         ...
                         ByVal kaihatsuFugo As String) As StructureResult
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function Compute(ByVal buhinNo As String, ByVal buhinNoKbn As String, ByVal IsInstlHinban As Boolean, ByVal KaihatsuFugo As String, ByVal targetTable As String, Optional ByVal shisakuEventCode As String = "") As StructureResult
