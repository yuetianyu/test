...
Namespace YosanBuhinEdit.Kosei.Dao
    Public Interface MakeStructureResultDao
        ...
        Function FindByBuhinColor0532(ByVal shisakuEventCode As String, _
                                      ...
                                      ByVal buhinNo As String) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindbyEditInstl(ByVal yosanEventCode As String, _
                                 ByVal patternName As String) As List(Of TYosanBuhinEditInsuVo)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindbyEdit(ByVal yosanEventCode As String, _
                            ByVal patternName As String) As List(Of TYosanBuhinEditVo)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindbySekkeiBlockInstlStructure(ByVal yosanEventCode As String, _
                                                 ByVal unitKbn As String, _
                                                 ByVal patternName As String) As List(Of TYosanBuhinEditPatternVo)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindbySekkeiBlockInstlStructureEventCopy(ByVal yosanEventCode As String, _
                                                          ByVal unitKbn As String, _
                                                          ByVal patternName As String) As List(Of TYosanBuhinEditPatternVo)
...
#Region "部品構成を取得する(FM5以降)"
        ...
        ''' <remarks></remarks>
        Function FindByEvent(ByVal shisakuEventCode As String) As THoyouEventVo
        ...
        ''' <returns>イベント情報</returns>
        ''' <remarks></remarks>
        Function FindByKaihatsuFugo(ByVal hoyouEventCode As String) As THoyouEventVo
...
#End Region
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindByBuhinMaker(ByVal BuhinNo As String) As THoyouBuhinEditVo
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindByBuhinShukei(ByVal BuhinNo As String) As THoyouBuhinEditVo
