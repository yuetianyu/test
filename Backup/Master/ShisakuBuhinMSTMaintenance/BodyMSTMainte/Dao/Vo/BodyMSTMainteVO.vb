...
Namespace ShisakuBuhinMSTMaintenance.BodyMSTMainte.Dao.Vo
    ''' <summary>
    ''' ボディマスタ表示用VO
    ''' </summary>
    ''' <remarks>
    ...
    Public Class BodyMSTMainteVO
        ...
        Private mBlockNo As String
        ''' <summary>XVLファイル名</summary>
        Private mXvlFileName As String
        ''' <summary>CADデータイベント区分</summary>
        Private mCadDataEventKbn As String
        ''' <summary>改訂番号</summary>
        Private mCadKaiteiNo As String
        ...
        Public Property CadDataEventKbn() As String
            Get
                Return mCadDataEventKbn
            End Get
            Set(ByVal value As String)
                mCadDataEventKbn = value
            End Set
        End Property
        ''' <summary>改訂番号</summary>
        Public Property CadKaiteiNo() As String
            Get
                Return mCadKaiteiNo
            End Get
            Set(ByVal value As String)
