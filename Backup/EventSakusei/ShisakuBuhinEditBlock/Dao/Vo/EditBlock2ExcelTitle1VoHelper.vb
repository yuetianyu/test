...
Namespace ShisakuBuhinEditBlock.Dao
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class EditBlock2ExcelTitle1VoHelper

        ''' <summary>試作イベントベース車情報項目No.</summary>
        Private Class ShisakuSoubiHyoujiJun
        ...
        Private Class ShisakuSoubiHyoujiJunName
            ...
            ''' <summary>完成試作試験目的</summary>
            Public Const KANSEI_SHIKEN_MOKUTEKI As String = "試験目的"
        ...
        ''' <remarks></remarks>
        Private Function GetNameByCode(ByVal strKomukuNo As String) As String
        ...
        Private vo As EditBlock2ExcelTitle1Vo

        ''' <summary>項目名</summary>
        Private _ShisakuSoubiHyoujiJunMei As String

        Public Sub New(ByVal vo As EditBlock2ExcelTitle1Vo)
            Me.vo = vo
            '項目名
