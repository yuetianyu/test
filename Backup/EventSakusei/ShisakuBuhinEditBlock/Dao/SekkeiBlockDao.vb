...
Namespace ShisakuBuhinEditBlock.Dao
    Public Interface SekkeiBlockDao
        ...
        ''' <remarks></remarks>
        Function FindByShisakuEventBase(ByVal shisakuEventCode As String, ByVal tantoId As String) As List(Of TShisakuEventBaseVo)
        ...
        ''' </summary>
        ''' <param name="shisakuEventCode">試作イベントコード</param>
        ''' <param name="tantoId">担当者ID</param>
        ''' <param name="HyojiJunNo">表示順</param>
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBase(ByVal shisakuEventCode As String, ByVal tantoId As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBaseByBlock(ByVal shisakuEventCode As String, ByVal tantoId As String, ByVal BlokNo As String) As List(Of SekkeiBlockAlResultVo)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBase2(ByVal shisakuEventCode As String, ByVal tantoId As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBase2ByBlock(ByVal shisakuEventCode As String, ByVal tantoId As String, ByVal BlokNo As String) As List(Of SekkeiBlockAlResultVo)
        ''' <summary>
        ''' 試作イベントベース車情報を元に、「A/Lの素情報」を抽出して返す
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBaseOLD(ByVal shisakuEventCode As String, ByVal tantoId As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo)
        ''' <summary>
        ''' 試作イベントベース車情報を元に、「A/Lの素情報」を抽出して返す
        ''' 　　ベース車情報に指定した仕様情報№－１で抽出する。
        ''' </summary>
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBaseOLDByBlock(ByVal shisakuEventCode As String, ByVal tantoId As String, ByVal BlokNo As String) As List(Of SekkeiBlockAlResultVo)
        ''' <summary>
        ''' 試作イベントベース車情報を元に、「A/Lの素情報」を抽出して返す
        ''' 　　ベース車情報に指定した仕様情報№－１で抽出する。
        ''' </summary>
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBaseOLD2(ByVal shisakuEventCode As String, ByVal tantoId As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo)
        ''' <summary>
        ''' 試作イベントベース車情報を元に、「A/Lの素情報」を抽出して返す
        ''' 　　ベース車情報に指定した仕様情報№－１で抽出する。
        ''' </summary>
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Function FindAlByShisakuEventBaseOLD2ByBlock(ByVal shisakuEventCode As String, ByVal tantoId As String, ByVal BlokNo As String) As List(Of SekkeiBlockAlResultVo)
