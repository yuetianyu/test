...
Imports EventSakusei.ShisakuBuhinEditBlock.Logic
...
Namespace ShisakuBuhinEditBlock
    Public Class SpdBaseCarObserver : Implements frm38SpdObserver, frm38SpdSetter(Of EventEditBaseCar)
#Region "各列のTAG"
...
#End Region
        ...
        Public Sub SupersedeSubject(ByVal subject As EventEditBaseCar) Implements frm38SpdSetter(Of EventEditBaseCar).SupersedeSubject
            Me.subject = subject
        ...
        Public Sub ClearSheetBackColor() Implements frm38SpdObserver.ClearSheetBackColor
        ...
        Public Sub ClearSheetData() Implements frm38SpdObserver.ClearSheetData
        ...
        Public Sub Initialize() Implements frm38SpdObserver.Initialize

            EventSpreadUtil.Initializefrm38(spread)
        ...
        Public Sub ReInitialize() Implements frm38SpdObserver.ReInitialize
            SpreadUtil.BindCellTypeToColumn(sheet, TAG_KAIHATSU_FUGO, NewKaihatsuFugoCellType())
            SpreadUtil.BindCellTypeToColumn(sheet, TAG_BASE_EVENT_CODE, NewBaseEventCodeCellType)
        End Sub
...
#End Region
        ...
        Private Sub LockRowByRule(ByVal row As Integer, ByVal IsLocked As Boolean)
            '          Dim aaa As New frm38DispEventEdit
        ...
        Public Sub OnChange(ByVal row As Integer, ByVal column As Integer) Implements frm38SpdObserver.OnChange
            Dim rowNo As Integer = row - titleRows
