...
Namespace ShisakuBuhinEdit.Kosei.Ui
    ''' <summary>
    ''' 補用部品構成編集画面で使用するCellTypeを一意に管理するクラス
    ''' </summary>
    ''' <remarks></remarks>
    Public Class HoyouBuhinSpdKoseiCellTypeFactory
        '' レベル
        ...
        ''' <value>員数</value>
        ''' <returns>員数</returns>
        Public ReadOnly Property InsuSuryoCellType() As TextCellType
            Get
                If _InsuSuryoCellType Is Nothing Then

                    _InsuSuryoCellType = ShisakuSpreadUtil.NewGeneralTextCellType()
                    '2014/11/19 変更
                    '_InsuSuryoCellType.MaxLength = 4
                    _InsuSuryoCellType.MaxLength = 2
                End If
                Return _InsuSuryoCellType
            End Get
        End Property
        ...
        Public ReadOnly Property MemoCellType() As TextCellType
            Get
                If _MemoCellType Is Nothing Then
                    ...
                    _MemoCellType.MaxLength = 2
                End If
                Return _MemoCellType
            End Get
        End Property

        ''' <summary>メモタイトル</summary>
        ''' <value>メモタイトル</value>
        ''' <returns>メモタイトル</returns>
        Public ReadOnly Property MemoTCellType() As TextCellType
            Get
                If _MemoTCellType Is Nothing Then

                    _MemoTCellType = ShisakuSpreadUtil.NewGeneralTextCellType()
                    _MemoTCellType.MaxLength = 61
                    '_BikouCellType.CharacterSet = CharacterSet.Hiragana  '' 全角も半角も入力出来る
                End If
                Return _MemoTCellType
            End Get
        End Property
