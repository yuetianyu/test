...
Namespace ShisakuBuhinEdit.Kosei.Dao
    Public Interface HoyouBuhinMakeStructureResultDao
        ''' <summary>
        ...
        Function FindbyEditInstl(ByVal shisakuEventCode As String, _
                                 ByVal instlHinban As String) As List(Of TShisakuBuhinEditInstlVo)
        ...
        Function FindbyEdit(ByVal shisakuEventCode As String, _
                            ByVal instlHinban As String) As List(Of THoyouBuhinEditVo)
...
#Region "部品構成を取得する(FM5以降)"
        ...
        ''' <returns></returns>
        ''' <remarks>
        ''' このインターフェースは開発符号を跨ぎ、部品番号の取得を行う
        ''' また、最新の単独部品取得とする
        ''' 20141218 TSUNODA ADD
        ''' </remarks>
        Function FindByBuhinRhac0553NowBuhinOnly(ByVal BFBuhinNo As String) As Rhac0553Vo
...
#End Region
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindbyHoyouBuhin(ByVal EventCode As String, ByVal BukaCode As String, _
                                  ByVal Tanto As String) As THoyouBuhinEditVo
