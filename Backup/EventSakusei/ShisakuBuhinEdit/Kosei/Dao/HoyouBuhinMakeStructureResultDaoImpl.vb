...
Namespace ShisakuBuhinEdit.Kosei.Dao
    Public Class HoyouBuhinMakeStructureResultDaoImpl : Implements HoyouBuhinMakeStructureResultDao
        ...
        ''' <remarks></remarks>
        Public Function FindStructure0552ByBuhinNoOya(ByVal BuhinNoOya As String) As List(Of Rhac0552Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0552ByBuhinNoOya
            Dim sql As String = _
        ...
        ''' <remarks></remarks>
        Public Function FindStructure0552ByBuhinNoOyaAnd0532ForKo(ByVal BuhinNoOya As String) As List(Of Rhac0532Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0552ByBuhinNoOyaAnd0532ForKo
            Dim sql As String = _
                SELECT_NEWEST_KOSEI_BY_BUHIN_NO_OYA() _
                & "SELECT B.* " _
        ...
        ''' <remarks></remarks>
        Public Function FindLastestRhac0532MakerNameByBuhinNo(ByVal BuhinNo As String) As Rhac0532BuhinNoteVo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0532MakerNameByBuhinNo
        ...
        ''' <remarks></remarks>
        Public Function FindLastestRhac0552ByBuhinNoKo(ByVal BuhinNoKo As String) As Rhac0552Vo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0552ByBuhinNoKo
            Dim sql As String = _
        ...
        ''' <remarks></remarks>
        Public Function FindStructure0552ByBuhinNoOyaAnd0610ForKo(ByVal BuhinNoOya As String) As List(Of Rhac0610Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0552ByBuhinNoOyaAnd0610ForKo
        ...
        ''' <remarks></remarks>
        Public Function FindByBuhinRhac0552(ByVal BFBuhinNo As String) As Rhac0552Vo Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0552
            Dim sql As String = _
            " SELECT * " _
        ...
        ''' <returns>部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinRhac0552LIST(ByVal BFBuhinNo As String) As List(Of Rhac0552Vo) Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0552LIST
            Dim sql As String = _
            " SELECT * " _
            & " FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0552 R WITH (NOLOCK, NOWAIT) " _
            & " WHERE " _
...
#Region "部品構成の取得(FM5以降)"
        ...
        ''' <remarks></remarks>
        Public Function FindByBase(ByVal shisakuEventCode As String, ByVal Gousya As String) As TShisakuEventBaseVo Implements HoyouBuhinMakeStructureResultDao.FindByBase
            Dim sql As String = _
            " SELECT * " _
        ...
        ''' <remarks></remarks>
        Public Function FindByEvent(ByVal hoyouEventCode As String) As THoyouEventVo Implements HoyouBuhinMakeStructureResultDao.FindByEvent
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
        ...
        ''' <returns>イベント情報</returns>
        ''' <remarks></remarks>
        Public Function FindByKaihatsugo(ByVal hoyouEventCode As String) As THoyouEventVo Implements HoyouBuhinMakeStructureResultDao.FindByKaihatsuFugo
            Dim sql As String = _
            " SELECT * " _
        ...
        ''' <remarks></remarks>
        Public Function FindByInstlBase(ByVal shisakuEventCode As String, ByVal shisakuBukaCode As String, ByVal shisakuBlockNo As String, ByVal BFBuhinNo As String) As TShisakuEventBaseVo Implements HoyouBuhinMakeStructureResultDao.FindByInstlBase
        ...
        ''' <returns>ベース車情報</returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinRhac0553(ByVal kaihatsuFugo As String, ByVal BFBuhinNo As String) As Rhac0553Vo Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0553
            Dim sql As String = _
            " SELECT * " _
        ...
        ''' <returns>ベース車情報</returns>
        ''' <remarks>
        ''' この部品取得は、開発符号を跨いで最新の部品番号情報を取得する為に使用する
        ''' 20141218 TSUNODA ADD
        ''' </remarks>
        Public Function FindByBuhinRhac0553NowBuhinOnly(ByVal BFBuhinNo As String) As Rhac0553Vo Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0553NowBuhinOnly

            Dim sql As New StringBuilder
            With sql
                .Remove(0, .Length)
                .Append(" SELECT TOP 1 * ")
                .Append(" FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0553 WITH (NOLOCK, NOWAIT) ")
                .Append(" WHERE ")
                .Append(" BUHIN_NO_OYA = 'T' ")
                .Append(" AND BUHIN_NO_KO = @BuhinNoOya ")
                .Append("	    AND HAISI_DATE = 99999999  ")
                '.Append(" AND R.KAITEI_NO = ( ")
                '.Append(" SELECT MAX ( CONVERT ( INT,COALESCE ( KAITEI_NO,'' ) ) ) AS KAITEI_NO ")
                '.Append(" FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0553  WITH (NOLOCK, NOWAIT)  ")
                '.Append(" WHERE KAIHATSU_FUGO = R.KAIHATSU_FUGO ")
                '.Append(" AND BUHIN_NO_OYA = R.BUHIN_NO_OYA  ")
                '.Append(" AND BUHIN_NO_KO = R.BUHIN_NO_KO ) ")
                ...
                Return db.QueryForObject(Of Rhac0553Vo)(sql.ToString, param)
        ...
        ''' <returns>ベース車情報</returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinRhac0553AL(ByVal BFBuhinNo As String) As Rhac0553Vo Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0553AL
            Dim sql As String = _
            " SELECT * " _
            & " FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0553 R WITH (NOLOCK, NOWAIT) " _
            & " WHERE " _
        ...
        ''' <returns>一連の構成情報</returns>
        ''' <remarks></remarks>
        Public Function FindStructure0553ByBuhinNoOya(ByVal buhinNoOya As String, ByVal kaihatsuFugo As String) As List(Of Rhac0553Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0553ByBuhinNoOya
            Dim sql As String = _
        ...
        ''' <returns>一連の構成情報に紐付く部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindStructure0553ByBuhinNoOyaAnd0533ForKo(ByVal buhinNoOya As String, ByVal kaihatsuFugo As String) As List(Of Rhac0533Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0553ByBuhinNoOyaAnd0533ForKo
            Dim sql As String = _
            SELECT_NEWEST_KOSEI_BY_BUHIN_NO_OYA_RHAC0553() _
            & "SELECT B.* " _
        ...
        ''' <returns>最終改訂の部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindLastestRhac0533MakerNameByBuhinNo(ByVal BuhinNo As String) As Rhac0533BuhinNoteVo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0533MakerNameByBuhinNo
            'Dim sql As String = _
        ...
        ''' <returns>最終改訂の部品構成情報</returns>
        ''' <remarks></remarks>
        Public Function FindLastestRhac0553ByBuhinNoKo(ByVal BuhinNoKo As String) As Rhac0553Vo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0553ByBuhinNoKo
            Dim sql As String = _
        ...
        ''' <returns>一連の構成情報に紐付く子の取引先情報</returns>
        ''' <remarks></remarks>
        Public Function FindStructure0553ByBuhinNoOyaAnd0610ForKo(ByVal BuhinNoOya As String) As List(Of Rhac0610Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0553ByBuhinNoOyaAnd0610ForKo
            Dim sql As String = _
            SELECT_NEWEST_KOSEI_BY_BUHIN_NO_OYA_RHAC0553() _
        ...
        ''' <returns>ベース車情報</returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinRhac0553LIST(ByVal kaihatsuFugo As String, ByVal BFBuhinNo As String) As List(Of Rhac0553Vo) Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0553LIST
            Dim sql As String = _
            " SELECT * " _
            & " FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0553 R WITH (NOLOCK, NOWAIT) " _
            & " WHERE " _
        ...
        Public Function FindbyEditInstl(ByVal shisakuEventCode As String, _
                                        ByVal instlHinban As String) As List(Of TShisakuBuhinEditInstlVo) Implements HoyouBuhinMakeStructureResultDao.FindbyEditInstl
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
        ...
        Public Function FindbyEdit(ByVal shisakuEventCode As String, _
                                          ByVal instlHinban As String) As List(Of THoyouBuhinEditVo) Implements HoyouBuhinMakeStructureResultDao.FindbyEdit
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
            ...
            Return db.QueryForList(Of THoyouBuhinEditVo)(sb.ToString, param)
        End Function
...
#Region "部品構成の取得(パンダ前)"
        ...
        ''' <returns>部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinRhac0551(ByVal BFBuhinNo As String) As Rhac0551Vo Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0551
            Dim sql As String = _
            " SELECT * " _
        ...
        ''' <returns>一連の構成情報</returns>
        ''' <remarks></remarks>
        Public Function FindStructure0551ByBuhinNoOya(ByVal buhinNoOya As String) As List(Of Rhac0551Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0551ByBuhinNoOya
            Dim sql As String = _
        ...
        ''' <returns>一連の構成情報に紐付く部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindStructure0551ByBuhinNoOyaAnd0530ForKo(ByVal buhinNoOya As String) As List(Of Rhac0530Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0551ByBuhinNoOyaAnd0530ForKo
            Dim sql As String = _
            SELECT_NEWEST_KOSEI_BY_BUHIN_NO_OYA_RHAC0551() _
            & "SELECT B.* " _
        ...
        ''' <returns>最終改訂の部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindLastestRhac0530MakerNameByBuhinNo(ByVal BuhinNo As String) As Rhac0530MakerNameVo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0530MakerNameByBuhinNo
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
        ...
        ''' <returns>最終改訂の部品構成情報</returns>
        ''' <remarks></remarks>
        Public Function FindLastestRhac0551ByBuhinNoKo(ByVal BuhinNoKo As String) As Rhac0551Vo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0551ByBuhinNoKo
            Dim sql As String = _
        ...
        ''' <returns>一連の構成情報に紐付く子の取引先情報</returns>
        ''' <remarks></remarks>
        Public Function FindStructure0551ByBuhinNoOyaAnd0610ForKo(ByVal BuhinNoOya As String) As List(Of Rhac0610Vo) Implements HoyouBuhinMakeStructureResultDao.FindStructure0551ByBuhinNoOyaAnd0610ForKo
            Dim sql As String = _
            SELECT_NEWEST_KOSEI_BY_BUHIN_NO_OYA_RHAC0551() _
            & "SELECT * FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0610 WITH (NOLOCK, NOWAIT) WHERE MAKER_CODE IN ( " _
            & "	SELECT B.MAKER_CODE " _
        ...
        ''' <returns>部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinRhac0551LIST(ByVal BFBuhinNo As String) As List(Of Rhac0551Vo) Implements HoyouBuhinMakeStructureResultDao.FindByBuhinRhac0551LIST
            Dim sql As String = _
            " SELECT * " _
            & " FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0551 R WITH (NOLOCK, NOWAIT) " _
            & " WHERE " _
...
#End Region
        ...
        ''' <remarks></remarks>
        Public Function FindShisakuBlockInstlbfBuhinNo(ByVal bfBuhinNo As String) As TShisakuSekkeiBlockInstlVo Implements HoyouBuhinMakeStructureResultDao.FindShisakuBlockInstlbfBuhinNo
        ...
        ''' <remarks></remarks>
        Public Function FindLastestRhac0532ByBuhinNoOya(ByVal BuhinNo As String) As Rhac0532Vo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0532ByBuhinNoOya
        ...
        ''' <returns>親の部品情報</returns>
        ''' <remarks></remarks>
        Public Function FindLastestRhac0530ByBuhinNoOya(ByVal BuhinNo As String) As Rhac0530Vo Implements HoyouBuhinMakeStructureResultDao.FindLastestRhac0530ByBuhinNoOya
        ...
        '                                          ByVal InstlHinbanKbn As String) As List(Of BuhinEditInstlKoseiVo) Implements HoyouBuhinMakeStructureResultDao.FindByBuhinEditInstlKosei
        '    Dim sql As String = _
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinMaker(ByVal BuhinNo As String) As THoyouBuhinEditVo Implements HoyouBuhinMakeStructureResultDao.FindByBuhinMaker
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function FindByBuhinShukei(ByVal BuhinNo As String) As THoyouBuhinEditVo Implements HoyouBuhinMakeStructureResultDao.FindByBuhinShukei
            '552, 553, 551, BuhinEditから検索する'
            Dim Result As New THoyouBuhinEditVo
            Dim db As New EBomDbClient
            ...
            If a532Vo Is Nothing Then
                ...
                End If
                'Else
                '    Result.ShukeiCode = a533Vo.ShukeiCode
                'End If
            Else
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindByRhac0532OyaKousei(ByVal BuhinNo As String) As Rhac0532Vo Implements HoyouBuhinMakeStructureResultDao.FindByRhac0532OyaKousei
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
        ...
        Public Function FindByBuhinColor0532(ByVal shisakuEventCode As String, _
                                             ...
                                             ByVal buhinNo As String) As String Implements HoyouBuhinMakeStructureResultDao.FindByBuhinColor0532
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
        ...
        Public Function FindByBuhinColor0530(ByVal shisakuEventCode As String, _
                                             ...
                                             ByVal instlHinban As String, _
                                             ByVal bfBuhinNo As String, _
                                             ByVal buhinNo As String) As String Implements HoyouBuhinMakeStructureResultDao.FindByBuhinColor0530
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
        ...
        Public Function FindByBuhinColor0533(ByVal shisakuEventCode As String, _
                                             ...
                                             ByVal buhinNo As String) As String Implements HoyouBuhinMakeStructureResultDao.FindByBuhinColor0533
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
        ...
        Public Function FindByBuhinColor2220(ByVal shisakuEventCode As String, _
                                             ...
                                             ByVal instlHinban As String, _
                                             ByVal bfBuhinNo As String, _
                                             ByVal buhinNo As String) As String Implements HoyouBuhinMakeStructureResultDao.FindByBuhinColor2220
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
        ...
        Public Function FindByBuhinColor0532Kosei(ByVal shisakuEventCode As String, _
                                                  ...
                                                  ByVal instlHinban As String, _
                                                  ByVal bfBuhinNo As String, _
                                                  ByVal buhinNo As String) As String Implements HoyouBuhinMakeStructureResultDao.FindByBuhinColor0532Kosei
        ...
        Public Function FindByBuhinColor0533Kosei(ByVal shisakuEventCode As String, _
                                           ...
                                           ByVal bfBuhinNo As String, _
                                           ByVal kaihatsuFugo As String, _
                                           ByVal buhinNo As String) As String Implements HoyouBuhinMakeStructureResultDao.FindByBuhinColor0533Kosei
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
        ...
        Public Function FindByBuhinColor0530Kosei(ByVal shisakuEventCode As String, _
                                           ...
                                           ByVal instlHinban As String, _
                                           ByVal bfBuhinNo As String, _
                                           ByVal buhinNo As String) As String Implements HoyouBuhinMakeStructureResultDao.FindByBuhinColor0530Kosei
        ...
        Public Function FindbySekkeiBlockInstlStructure(ByVal shisakuEventCode As String, _
                                                        ByVal instlHinban As String, _
                                                        ByVal instlHinbanKbn As String) As List(Of TShisakuSekkeiBlockInstlVo) Implements HoyouBuhinMakeStructureResultDao.FindbySekkeiBlockInstlStructure
            Dim sb As New StringBuilder
            With sb
        ...
        Public Function FindbySekkeiBlockInstlStructureEventCopy(ByVal shisakuEventCode As String, _
                                                                 ByVal instlHinban As String, _
                                                                 ByVal instlHinbanKbn As String) As List(Of TShisakuSekkeiBlockInstlVo) Implements HoyouBuhinMakeStructureResultDao.FindbySekkeiBlockInstlStructureEventCopy
            Dim sb As New StringBuilder
            With sb
                .AppendLine(" SELECT DISTINCT SBI.SHISAKU_EVENT_CODE, ")
                .AppendLine(" SBI.SHISAKU_BUKA_CODE, ")
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function FindbyHoyouBuhin(ByVal EventCode As String, ByVal BukaCode As String, _
                                         ByVal Tanto As String) As THoyouBuhinEditVo Implements HoyouBuhinMakeStructureResultDao.FindbyHoyouBuhin
            Dim sb As New StringBuilder
            With sb
                .AppendLine(" SELECT ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_1) AS MEMO_SHEET_1, ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_2) AS MEMO_SHEET_2, ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_3) AS MEMO_SHEET_3, ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_4) AS MEMO_SHEET_4, ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_5) AS MEMO_SHEET_5, ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_6) AS MEMO_SHEET_6, ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_7) AS MEMO_SHEET_7, ")
                .AppendLine(" MAX(EDIT.MEMO_SHEET_8) AS MEMO_SHEET_8, ")
                .AppendLine(" MAX(EDIT.MEMO_DOOR_TRIM_1) AS MEMO_DOOR_TRIM_1, ")
                .AppendLine(" MAX(EDIT.MEMO_DOOR_TRIM_2) AS MEMO_DOOR_TRIM_2, ")
                .AppendLine(" MAX(EDIT.MEMO_ROOF_TRIM_1) AS MEMO_ROOF_TRIM_1, ")
                .AppendLine(" MAX(EDIT.MEMO_ROOF_TRIM_1) AS MEMO_ROOF_TRIM_2, ")
                .AppendLine(" MAX(EDIT.MEMO_SUNROOF_TRIM_1) AS MEMO_SUNROOF_TRIM_1, ")
                .AppendLine(" EDIT.HOYOU_EVENT_CODE, ")
                .AppendLine(" EDIT.HOYOU_BUKA_CODE, ")
                .AppendLine(" EDIT.HOYOU_TANTO, ")
                .AppendLine(" EDIT.HOYOU_TANTO_KAITEI_NO ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_HOYOU_BUHIN_EDIT EDIT")
                .AppendLine(" WHERE ")
                .AppendLine(" EDIT.HOYOU_EVENT_CODE = @HoyouEventCode ")
                .AppendLine(" AND EDIT.HOYOU_BUKA_CODE = @HoyouBukaCode ")
                .AppendLine(" AND EDIT.HOYOU_TANTO = @HoyouTanto ")
                .AppendLine(" AND EDIT.HOYOU_TANTO_KAITEI_NO = ( ")
                .AppendLine("  SELECT MAX ( CONVERT ( INT,COALESCE ( HOYOU_TANTO_KAITEI_NO,'' ) ) ) AS KAITEI_NO ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_HOYOU_BUHIN_EDIT WITH (NOLOCK, NOWAIT)   ")
                .AppendLine(" WHERE EDIT.HOYOU_EVENT_CODE = HOYOU_EVENT_CODE ")
                .AppendLine(" AND EDIT.HOYOU_BUKA_CODE = HOYOU_BUKA_CODE ")
                .AppendLine(" AND EDIT.HOYOU_TANTO = HOYOU_TANTO ) ")
                .AppendLine(" GROUP BY ")
                .AppendLine(" EDIT.HOYOU_EVENT_CODE, ")
                .AppendLine(" EDIT.HOYOU_BUKA_CODE, ")
                .AppendLine(" EDIT.HOYOU_TANTO, ")
            ...
            param.HoyouEventCode = EventCode
            param.HoyouBukaCode = BukaCode
            param.HoyouTanto = Tanto

            Return db.QueryForObject(Of THoyouBuhinEditVo)(sb.ToString, param)
        End Function
