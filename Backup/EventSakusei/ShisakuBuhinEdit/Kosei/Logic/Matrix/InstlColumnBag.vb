Namespace ShisakuBuhinEdit.Kosei.Logic.Matrix
    ...
    Public Class InstlColumnBag
        ...
        Private Class InsuCellBag
            ...
            ''' <remarks></remarks>
            Public Sub New(ByVal KoseiRecordVo As BuhinKoseiRecordVo, ByVal InsuVo As BuhinKoseiInsuCellVo)
                Me.KoseiRecordVo = KoseiRecordVo
                Me.InsuVo = InsuVo
            End Sub
            Public Function Clone() As InsuCellBag
                Return CType(MemberwiseClone(), InsuCellBag)
            End Function
        End Class


        Public Function Clone() As InstlColumnBag
            Dim rtn As InstlColumnBag = CType(MemberwiseClone(), InstlColumnBag)
            Dim cells As New List(Of InsuCellBag)
            For Each cell As InsuCellBag In _cells
                cells.Add(cell.Clone)
            Next
            rtn._cells = cells
            Dim keys As New List(Of BuhinKoseiRecordVo)
            For Each key As BuhinKoseiRecordVo In _keys
                keys.Add(key.Clone)
            Next
            rtn._keys = keys
            Return rtn
        ...
        Private _keys As New List(Of BuhinKoseiRecordVo)
        ...
        ''' <returns>行情報</returns>
        ''' <remarks></remarks>
        Default Public ReadOnly Property Record(ByVal index As Integer) As BuhinKoseiRecordVo
            Get
                If _cells Is Nothing OrElse _cells.Count = 0 Then Return Nothing
        ...
        Public Function IndexOf(ByVal recordVo As BuhinKoseiRecordVo) As Integer
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function Contains(ByVal recordVo As BuhinKoseiRecordVo) As Boolean
        ...
        ''' <param name="recordVo">行情報</param>
        ''' <remarks></remarks>
        Public Sub Remove(ByVal recordVo As BuhinKoseiRecordVo)
        ...
        ''' <remarks></remarks>
        Public Sub Add(ByVal recordVo As BuhinKoseiRecordVo, ByVal insuVo As BuhinKoseiInsuCellVo)
            _keys.Add(recordVo)
        ...
        ''' <param name="insuVo">セルの員数情報</param>
        ''' <remarks></remarks>
        Public Sub Insert(ByVal index As Integer, ByVal recordVo As BuhinKoseiRecordVo, ByVal insuVo As BuhinKoseiInsuCellVo)
            If Count <= index Then
                Add(recordVo, insuVo)
                Return
            End If
        ...
        Public Sub RemoveCell(ByVal index As Integer)
            '行番号を表すのか列番号を表すのか不明'
            '_keys(index) = New BuhinKoseiRecordVo()
