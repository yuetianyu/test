...
#Region "3ヶ月インフォメーション"
    ...
    Private Function FindKPSM10P() As Boolean
        ...
        '3ヶ月インフォメーション
        dtResult = TehaichoEditImpl.FindKPSM10P(_ebomDb, _buhinNo, _seihinKubun)
...
#Region "パーツプライスリスト"
    ...
    Private Function findPARTSP() As Boolean
        ...
        dtResult = TehaichoEditImpl.FindPARTSP(_ebomDb, _buhinNo)
...
#Region "海外生産マスタ"
    ...
    Private Function FindGKPSM10P() As Boolean
        ...
        dtResult = TehaichoEditImpl.FindGKPSM10P(_ebomDb, _buhinNo, _seihinKubun)
...
#Region "部品マスタ"
    Private Function FindBUHIN01() As Boolean
        ...
        'BUHIN01からだけ見てる・・・'
        dtResult = TehaichoEditImpl.FindBUHIN01(_ebomDb, buhiNo10)
...
#Region "属性管理(開発符号毎)"
    ...
    Private Function FindValueDev() As Boolean
        ...
        dtResult = TehaichoEditImpl.FindValueDev(_koseiDb, _kaihatsuFugo, buhiNo10)
