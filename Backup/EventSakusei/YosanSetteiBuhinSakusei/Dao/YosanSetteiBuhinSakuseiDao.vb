...
Namespace YosanSetteiBuhinSakusei.Dao
    Public Interface YosanSetteiBuhinSakuseiDao
...
#Region "取得する処理(Find)"
        ...
        Function FindByMaxGousyaHyoujijunNotDummy(ByVal shisakuEventCode As String, _
                                                  ByVal shisakuListCode As String) As Integer
        ...
        ''' <remarks></remarks>
        Function FindByHyoujijunNo(ByVal shisakuEventCode As String) As TYosanSetteiListcodeVo
        ...
        ''' <remarks></remarks>
        Function FindByListCode(ByVal shisakuEventCode As String, ByVal shisakuKoujiShireiNo As String) As TYosanSetteiListcodeVo
        ...
        Function FindByBuhin(ByVal shisakEventCode As String, _
                             ...
                             ByVal JikyuFlg As Boolean) As List(Of YosanSetteiBuhinEditTmpVo)
        ...
        ''' <returns>該当するBlockINSTL情報のリスト</returns>
        ''' <remarks></remarks>
        Function FindByBuhinTmpGosya(ByVal shisakEventCode As String, ByVal shisakuGroup As String, ByVal JikyuFlg As Boolean) As List(Of TYosanSetteiGousyaTmpVo)
        ...
        Function FindByBuhinTmp(ByVal shiskuEventCode As String, _
                                ByVal shisakuListCode As String) As List(Of TYosanSetteiBuhinTmpVo)
        ...
        ''' <remarks></remarks>
        Function FindByBuhinTmpList(ByVal shisakuEventCode As String, ByVal shisakuListCode As String, ByVal shisakuBlockNo As String) As List(Of TYosanSetteiBuhinTmpVo)
        ...
        ''' <remarks></remarks>
        Function FindByBuhinGousyaTmpList(ByVal shisakuEventCode As String, ByVal shisakuBlockNo As String) As List(Of TYosanSetteiGousyaTmpVo)
        ...
        Function FindByKoutanTorihikisakiSakusei(ByVal buhinNo As String, _
                                                 ...
                                                 ByVal aRhac0610 As List(Of Rhac0610Vo)) As TYosanSetteiBuhinTmpVo
        ''' <summary>
        ''' 購担/取引先を取得する
        ''' </summary>
        ''' <param name="buhinNo">部品No</param>
        ''' <returns>購担と取引先</returns>
        ''' <remarks></remarks>
        Function FindByKoutanTorihikisaki(ByVal buhinNo As String) As TYosanSetteiBuhinTmpVo
        ...
        Function FindByBuhinNoOyaKbn(ByVal kaihatsuFugo As String, _
                                     ...
                                     ByVal siaShukeiCode As String) As TYosanSetteiBuhinTmpVo
        ...
        Function FindByDummyTehaiGousya(ByVal shisakuEventCode As String, _
                                         ...
                                         ByVal shisakuBukaCode As String, _
                                         ByVal shisakuBlockNo As String) As TYosanSetteiGousyaVo
        ...
        Function FindByTehaiMergeList(ByVal shisakuEventCode As String, _
                                      ...
                                      ByVal shisakuBukaCode As String, _
                                      ByVal shisakuBlockNo As String, _
                                      ByVal shisakuBlockNoKaiteiNo As String) As List(Of YosanSetteiBuhinEditTmpVo)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindByTehaiKihonList(ByVal shisakuEventCode As String, ByVal shisakuListCode As String) As List(Of TYosanSetteiBuhinVo)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindByBuhinEditTmp(ByVal shisakuEventCode As String, ByVal shisakuListCode As String) As List(Of TYosanSetteiBuhinTmpVo)
        ...
        Function FindByBuhin3D(ByVal shisakEventCode As String, _
                               ByVal shisakuGroup As String, _
                               ByVal shisakuGousya As Dictionary(Of Integer, String)) As List(Of YosanSetteiBuhinEditTmpVo)
...
#Region "更新する処理(Update)"
        ...
        ''' <remarks></remarks>
        Sub UpdateByBuhinEditGousyaTmp(ByVal gousyaTmpVo As TYosanSetteiGousyaTmpVo)
        ...
        ''' <remarks></remarks>
        Sub UpdateByTehaiGousyaGyouID(ByVal tehaiGousyaVoList As List(Of TYosanSetteiGousyaVo))
        ...
        ''' <remarks></remarks>
        Sub UpdateByTehaiGousyaInsuTotal(ByVal tehaiGousyaVo As TYosanSetteiGousyaVo)
        ...
        ''' <remarks></remarks>
        Sub UpdateByGyouId(ByVal tehaiKihonVoList As List(Of TYosanSetteiBuhinVo))
        ...
        ''' <remarks></remarks>
        Sub UpdateBySenyouMark(ByVal buhinEditTmpVoList As List(Of TYosanSetteiBuhinTmpVo))
...
#Region "挿入する処理(Insert)"
        ...
        ''' <remarks></remarks>
        Sub InsertByBuhinEditTMP(ByVal shisakuBuhinEditvo As List(Of YosanSetteiBuhinEditTmpVo), _
        ...
        ''' <remarks></remarks>
        Sub InsertByGousyaTMP(ByVal gousyaTmpvo As List(Of YosanSetteiBuhinEditTmpVo))
        ...
        ''' <remarks></remarks>
        Sub InsertByTehaiKihon2(ByVal MergeList As List(Of YosanSetteiBuhinEditTmpVo), _
                               ByVal seihinKbn As String, _
                               ByVal shisakuListCode As String, _
        ...
        ''' <param name="MergeList">マージした情報</param>
        ''' <remarks></remarks>
        Sub InsertByTehaiGousya2(ByVal MergeList As List(Of YosanSetteiBuhinEditTmpVo), _
        ...
        ''' <remarks></remarks>
        Sub InsertByTehaiGousya(ByVal gousyaVo As TYosanSetteiGousyaVo)
        ...
        ''' <remarks></remarks>
        Sub InserByDummyTehaiGousya(ByVal DummyVo As TYosanSetteiGousyaVo)
