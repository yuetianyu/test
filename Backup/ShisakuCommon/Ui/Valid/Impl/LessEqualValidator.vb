...
Namespace Ui.Valid.Impl
    ...
    ''' <remarks>入力した値 <![CDATA[<=]]> 指定の値 . であることをチェックする</remarks>
    Friend Class LessEqualValidator(Of T) : Inherits AbstractValidator(Of T)

        Private Const DEFAULT_MESSAGE As String = "{0} は、{1} と同じか、それより小さい値を入力して下さい."
