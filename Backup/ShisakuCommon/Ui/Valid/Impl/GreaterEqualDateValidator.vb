...
Namespace Ui.Valid.Impl
    ...
    ''' 日付の大小比較チェックを担うクラス
    ''' </summary>
    ''' <remarks>指定の日付 <![CDATA[<=]]> 入力した日付 であることをチェックする</remarks>
    Friend Class GreaterEqualDateValidator : Inherits AbstractValidator(Of DateTime)

        Private Const DEFAULT_MESSAGE As String = "{0} は、{1} と同じか、それより新しい日付を入力して下さい."
