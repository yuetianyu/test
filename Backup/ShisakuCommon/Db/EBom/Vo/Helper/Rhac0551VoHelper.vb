Namespace Db.EBom.Vo.Helper
    Public Class Rhac0551VoHelper
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function ResolveBuhinNoOyaFrom(ByVal vo As Rhac0551Vo) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function ResolveBuhinNoKoFrom(ByVal vo As Rhac0551Vo) As String
        ...
        ''' <remarks></remarks>
        Public Shared Sub ResolveRule(ByVal ParamArray vos As Rhac0551Vo())
        ...
        ''' <param name="vos">構成情報</param>
        ''' <remarks></remarks>
        Public Shared Sub ResolveRule(ByVal vos As List(Of Rhac0551Vo))
            ResolveRule(vos.ToArray)
        End Sub

        Private ReadOnly vo As Rhac0551Vo
        Public Sub New(ByVal vo As Rhac0551Vo)
            Me.vo = vo
        End Sub
    End Class
End Namespace