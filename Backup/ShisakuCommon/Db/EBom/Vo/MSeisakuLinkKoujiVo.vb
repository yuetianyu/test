...
Namespace Db.EBom.Vo
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class MSeisakuLinkKoujiVo
        ...
        ''' <summary>ユニット区分(T OR M)</summary>
        Private _UnitKbn As String

        ''' <summary>工事指令№表示順</summary>
        Private _KoujiShireiNoHyojijunNo As Integer
        ...
        ''' <summary>工事指令№表示順取得・設定</summary>
        ''' <value>工事指令№表示順</value>
        ''' <returns>工事指令№表示順</returns>
        Public Property KoujiShireiNoHyojijunNo() As Integer
            Get
