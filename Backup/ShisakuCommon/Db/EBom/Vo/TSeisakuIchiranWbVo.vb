Namespace Db.EBom.Vo
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class TSeisakuIchiranWbVo
        '' 発行№
        ...
        '' 主要確認項目区分
        Private _SyuyoukakuninKoumokuKbn As String
        '' メモ欄
        ...
        ''' <summary>主要確認項目区分</summary>
        ''' <value>主要確認項目区分</value>
        ''' <returns>主要確認項目区分</returns>
        Public Property SyuyoukakuninKoumokuKbn() As String
            Get
                Return _SyuyoukakuninKoumokuKbn
            End Get
            Set(ByVal value As String)
                _SyuyoukakuninKoumokuKbn = value
            End Set
        End Property
