Namespace Db.EBom.Vo
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class AsGKPSM10PVo

        ''' <summary>工事指令 NO</summary>
        ...
        ''' <summary>ＳＮＰ</summary>
        Private _Snp As Nullable(Of Int32)
        ''' <summary>納入ロット</summary>
        Private _Norot As Nullable(Of Int32)
        ...
        Private _Hyota As Nullable(Of Int32)
        ...
        Public Property Hyota() As Nullable(Of Int32)
            Get
                Return _Hyota
            End Get
            Set(ByVal value As Nullable(Of Int32))
