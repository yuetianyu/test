Namespace Db.EBom.Vo
    ''' <summary>試作部品編集情報（ベース）</summary>
    Public Class TShisakuBuhinEditBaseVo
        ...
        Private _BaseBuhinSeq As Nullable(Of Int32)
        ...
        ''' <summary>ベース情報シーケンス</summary>
        ''' <value>ベース情報シーケンス</value>
        ''' <returns>ベース情報シーケンス</returns>
        Public Property BaseBuhinSeq() As Nullable(Of Int32)
            Get
                Return _BaseBuhinSeq
            End Get
            Set(ByVal value As Nullable(Of Int32))
                _BaseBuhinSeq = value
            End Set
