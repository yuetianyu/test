Namespace Db.EBom.Vo
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class TShisakuSekkeiBlockInstlVo
        '' 試作イベントコード
        ...
        Private _BaseInstlHinbanHyoujiJun As Nullable(Of Int32)
        ...
        ''' <value>INSTL品番表示順</value>
        ''' <returns>INSTL品番表示順</returns>
        Public Property BaseInstlHinbanHyoujiJun() As Nullable(Of Int32)
            Get
                Return _BaseInstlHinbanHyoujiJun
            End Get
            Set(ByVal value As Nullable(Of Int32))
                _BaseInstlHinbanHyoujiJun = value
            End Set
        End Property
