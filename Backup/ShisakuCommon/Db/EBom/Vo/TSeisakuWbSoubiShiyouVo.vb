Namespace Db.EBom.Vo
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class TSeisakuWbSoubiShiyouVo
        '' 発行№
        ...
        '' 装備仕様列表示順
        Private _SoubishiyouHyoujijunNo As Nullable(of Int32)
        '' 号車
        ...
        ''' <summary>装備仕様列表示順</summary>
        ''' <value>装備仕様列表示順</value>
        ''' <returns>装備仕様列表示順</returns>
        Public Property SoubishiyouHyoujijunNo() As Nullable(of Int32)
            Get
                Return _SoubishiyouHyoujijunNo
            End Get
            Set(ByVal value As Nullable(of Int32))
                _SoubishiyouHyoujijunNo = value
            End Set
        End Property
