...
Namespace Db.EBom.Dao
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Interface TShisakuFBuhinDao : Inherits DaoEachTable(Of TShisakuFBuhinVo)
        ''' <summary>
        ''' テーブル値の検索結果を返す
        ''' </summary>
        ...
        Function FindByPk(ByVal shisakuEventCode As String, _
                          ...
                          ByVal fBuhinNoKbn As String) As TShisakuFBuhinVo
        ...
        Function DeleteByPk(ByVal shisakuEventCode As String, _
                            ...
                            ByVal instlHinbanKbn As String, _
                            ByVal fBuhinNo As String, _
                            ByVal fBuhinNoKbn As String) As Integer
