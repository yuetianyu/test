...
Namespace Db.EBom.Dao
    ''' <summary>試作部品編集・INSTL情報（ベース）の簡単なCRUDを集めたDAO</summary>
    Public Interface TShisakuBuhinEditInstlBaseDao : Inherits DaoEachTable(Of TShisakuBuhinEditInstlBaseVo)
        ...
        Function FindByPk(ByVal ShisakuEventCode As String, _
                          ...
                          ByVal InstlHinbanHyoujiJun As Nullable(Of Int32)) As TShisakuBuhinEditInstlBaseVo
