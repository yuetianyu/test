...
Namespace Db.EBom.Dao
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Interface TShisakuBuhinEditEbomKanshiDao : Inherits DaoEachTable(Of TShisakuBuhinEditEbomKanshiVo)
        ''' <summary>
        ''' テーブル値の検索結果を返す
        ''' </summary>
        ...
        Function FindByPk(ByVal shisakuEventCode As String, _
                         ...
                         ByVal buhinNoHyoujiJun As Nullable(Of Int32)) As TShisakuBuhinEditEbomKanshiVo
        ''' <summary>
        ''' 該当レコードを削除する
        ''' </summary>
        ''' <param name="shisakuEventCode">試作イベントコード</param>
