...
Namespace Db.EBom.Dao
    ''' <summary>試作部品編集情報（TMP）の簡単なCRUDを集めたDAO</summary>
    Public Interface TShisakuBuhinEditTmp3dDao : Inherits DaoEachTable(Of TShisakuBuhinEditTmp3dVo)
        ...
        Function FindByPk(ByVal Guid As String, _
                          ...
                          ByVal GyouId As String) As TShisakuBuhinEditTmp3dVo
