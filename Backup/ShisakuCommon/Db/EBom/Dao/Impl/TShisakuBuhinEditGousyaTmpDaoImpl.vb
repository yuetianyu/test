...
Namespace Db.EBom.Dao.Impl
    ...
    Public Class TShisakuBuhinEditGousyaTmpDaoImpl : Inherits EBomDaoEachTable(Of TShisakuBuhinEditGousyaTmpVo)
        Implements TShisakuBuhinEditGousyaTmpDao
        ''' <summary>PrimaryKey を設定する</summary>
        ''' <param name="table">テーブルに対応するVOのインスタンス</param>
        ''' <remarks></remarks>
        Protected Overrides Sub SettingPkField(ByVal table As PkTable(Of Vo.TShisakuBuhinEditGousyaTmpVo))
        ...
        Public Function FindByPk(ByVal ShisakuEventCode As String, _
                          ...
                          ByVal GyouId As String) As TShisakuBuhinEditGousyaTmpVo Implements TShisakuBuhinEditGousyaTmpDao.FindByPk
        ...
        Function DeleteByPk(ByVal ShisakuEventCode As String, _
                          ...
                          ByVal ShisakuBlockNoKaiteiNo As String, _
                          ByVal BuhinNoHyoujiJun As Nullable(Of Int32), _
                          ByVal GyouId As String) As Integer Implements TShisakuBuhinEditGousyaTmpDao.DeleteByPk
