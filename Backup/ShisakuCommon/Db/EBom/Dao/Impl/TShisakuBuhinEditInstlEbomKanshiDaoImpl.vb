...
Namespace Db.EBom.Dao.Impl
    ...
    ''' <summary>
    ''' 試作部品編集・INSTL情報(EBOM設変)テーブルの簡単なCRUDを集めたDAO
    ''' </summary>
    ''' <remarks></remarks>
    Public Class TShisakuBuhinEditInstlEbomKanshiDaoImpl : Inherits EBomDaoEachTable(Of TShisakuBuhinEditInstlEbomKanshiVo)
        Implements TShisakuBuhinEditInstlEbomKanshiDao
        ...
        ''' <remarks></remarks>
        Protected Overrides Sub SettingPkField(ByVal table As PkTable(Of Vo.TShisakuBuhinEditInstlEbomKanshiVo))
            Dim vo As New TShisakuBuhinEditInstlEbomKanshiVo
            table.IsA(vo) _
        ...
        Public Function FindByPk(ByVal shisakuEventCode As String, _
                                 ...
                                 ByVal instlHinbanHyoujiJun As Nullable(Of Int32)) As Vo.TShisakuBuhinEditInstlEbomKanshiVo Implements TShisakuBuhinEditInstlEbomKanshiDao.FindByPk
        ...
        Public Function DeleteByPk(ByVal shisakuEventCode As String, _
                                 ...
                                 ByVal shisakuBlockNoKaiteiNo As String, _
                                 ByVal buhinNoHyoujiJun As Nullable(Of Int32), _
                                 ByVal instlHinbanHyoujiJun As Nullable(Of Int32)) As Integer Implements TShisakuBuhinEditInstlEbomKanshiDao.DeleteByPk
