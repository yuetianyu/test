...
Namespace Db.EBom.Dao
    ...
    Public Interface TShisakuBuhinEditGousyaTmpDao : Inherits DaoEachTable(Of TShisakuBuhinEditGousyaTmpVo)
        ...
        Function FindByPk(ByVal ShisakuEventCode As String, _
                          ...
                          ByVal GyouId As String) As TShisakuBuhinEditGousyaTmpVo
