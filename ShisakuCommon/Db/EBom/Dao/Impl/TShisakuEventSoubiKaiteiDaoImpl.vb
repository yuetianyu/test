...
Namespace Db.EBom.Dao.Impl
    ...
    Public Class TShisakuEventSoubiKaiteiDaoImpl : Inherits EBomDaoEachTable(Of TShisakuEventSoubiKaiteiVo)
        Implements TShisakuEventSoubiKaiteiDao
        ...
        ''' <remarks></remarks>
        Protected Overrides Sub SettingPkField(ByVal table As PkTable(Of TShisakuEventSoubiKaiteiVo))
            Dim vo As New TShisakuEventSoubiKaiteiVo
            table.IsA(vo) _
        ...
        Public Function FindByPk(ByVal shisakuEventCode As String, ByVal hyojijunNo As Nullable(Of Int32) _
                         ...
                         , ByVal shisakuRetuKoumokuCode As String) As Vo.TShisakuEventSoubiKaiteiVo Implements TShisakuEventSoubiKaiteiDao.FindByPk
        ...
        Public Function DeleteByPk(ByVal shisakuEventCode As String, ByVal hyojijunNo As Nullable(Of Int32) _
                         , ByVal shisakuTokubetuSoubiHyoujiNo As Nullable(Of Int32), ByVal shisakuTokubetuSoubiKbn As String _
                         , ByVal shisakuRetuKoumokuCode As String) As Integer Implements TShisakuEventSoubiKaiteiDao.DeleteByPk
