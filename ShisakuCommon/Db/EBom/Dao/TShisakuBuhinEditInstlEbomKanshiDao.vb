...
Namespace Db.EBom.Dao
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Interface TShisakuBuhinEditInstlEbomKanshiDao : Inherits DaoEachTable(Of TShisakuBuhinEditInstlEbomKanshiVo)
        ''' <summary>
        ''' テーブル値の検索結果を返す
        ''' </summary>
        ...
        Function FindByPk(ByVal shisakuEventCode As String, _
                          ...
                          ByVal instlHinbanHyoujiJun As Nullable(Of Int32)) As TShisakuBuhinEditInstlEbomKanshiVo
