...
Namespace Db.EBom.Dao
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Interface TShisakuTehaiShutuzuJisekiInputDao : Inherits DaoEachTable(Of TShisakuTehaiShutuzuJisekiInputVo)
        ''' <summary>
        ''' テーブル値の検索結果を返す
        ''' </summary>
        ...
        Function FindByPk(ByVal ShisakuEventCode As String, _
                          ...
                          ByVal ShutuzuJisekiKaiteiNo As String) As TShisakuTehaiShutuzuJisekiInputVo
        ...
        Function DeleteByPk(ByVal ShisakuEventCode As String, _
                            ...
                            ByVal ShisakuBlockNo As String, _
                            ByVal BuhinNo As String, _
                            ByVal ShutuzuJisekiKaiteiNo As String) As Integer
