Namespace Db.EBom.Vo
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class TShisakuSekkeiBlockTsuchiVo
        '' 試作イベントコード
        ...
        '' メール通知日
        Private _MailTsuchiHI As Nullable(of Int32)
        '' 作成ユーザーID
        ...
        ''' <summary>メール通知日</summary>
        ''' <value>メール通知日</value>
        ''' <returns>メール通知日</returns>
        Public Property MailTsuchiHi() As Nullable(of Int32)
            Get
                Return _MailTsuchiHi
            End Get
            Set(ByVal value As Nullable(of Int32))
                _MailTsuchiHi = value
            End Set
