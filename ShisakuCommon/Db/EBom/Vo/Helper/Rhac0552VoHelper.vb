Namespace Db.EBom.Vo.Helper
    Public Class Rhac0552VoHelper
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function ResolveBuhinNoOyaFrom(ByVal vo As Rhac0552Vo) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function ResolveBuhinNoKoFrom(ByVal vo As Rhac0552Vo) As String
        ...
        ''' <remarks></remarks>
        Public Shared Sub ResolveRule(ByVal ParamArray vos As Rhac0552Vo())
        ...
        ''' <param name="vos">構成情報</param>
        ''' <remarks></remarks>
        Public Shared Sub ResolveRule(ByVal vos As List(Of Rhac0552Vo))
            ResolveRule(vos.ToArray)
        End Sub

        Private ReadOnly vo As Rhac0552Vo
        Public Sub New(ByVal vo As Rhac0552Vo)
            Me.vo = vo
        End Sub
