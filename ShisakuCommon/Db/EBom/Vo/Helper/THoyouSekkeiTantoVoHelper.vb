Namespace Db.EBom.Vo.Helper
    Public Class THoyouSekkeiTantoVoHelper
        ''' <summary>補用担当表示順</summary>
        Public Class HoyouTantoHyoujiJun
            ''' <summary>開始値</summary>
        ...
        Public Class HoyouTantoKaiteiNo
            ''' <summary>初期値</summary>
            Public Const DEFAULT_VALUE As String = "000"
        End Class
        ''' <summary>不要</summary>
        Public Class TantoFuyou
            ''' <summary>必要</summary>
...
#End Region
        ...
        ''' <summary>補用設計担当Vo</summary>
        Private vo As THoyouSekkeiTantoVo
        ''' <summary>
        ''' Construct
        ''' </summary>
        ''' <param name="vo">補用設計担当Vo</param>
        ''' <remarks></remarks>
        Public Sub New(ByVal vo As THoyouSekkeiTantoVo)
            Me.vo = vo
        End Sub
    End Class
End Namespace