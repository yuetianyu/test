Namespace Db.EBom.Vo
    ...
    Public Class Rhac1930Vo
        ...
        '' 部品型改訂No
        Private _BuhinKataKaiteiNo As String
        '' 型代表部品番号
        ...
        ''' <summary>部品型改訂No</summary>
        ''' <value>部品型改訂No</value>
        ''' <returns>部品型改訂No</returns>
        Public Property BuhinKataKaiteiNo() As String
            Get
                Return _BuhinKataKaiteiNo
            End Get
            Set(ByVal value As String)
                _BuhinKataKaiteiNo = value
            End Set
        End Property
