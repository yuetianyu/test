...
Namespace Db.Impl
    Public Class ShisakuDaoImpl : Inherits DaoEachFeatureImpl
        Implements ShisakuDao
        ...
        ''' <returns>日時</returns>
        ''' <remarks></remarks>
        Public Overridable Function GetCurrentTimestamp() As DateTime Implements ShisakuDao.GetCurrentTimestamp
        ...
        Public Overridable Function FindUserById(ByVal userId As String) As Rhac0650Vo Implements ShisakuDao.FindUserById
