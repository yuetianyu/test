...
Namespace Db.Impl
    Public Class HoyouDaoImpl : Inherits DaoEachFeatureImpl
        Implements HoyouDao
        ...
        ''' <returns>日時</returns>
        ''' <remarks></remarks>
        Public Overridable Function GetCurrentTimestamp() As DateTime Implements HoyouDao.GetCurrentTimestamp
        ...
        Public Overridable Function FindUserById(ByVal userId As String) As Rhac0650Vo Implements HoyouDao.FindUserById
