...
Namespace Dao
    Public Class YakanSekkeiBlockDaoImpl : Implements YakanSekkeiBlockDao
        ...
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAri(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBase
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriNoBuhin(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseNoBuhin
            Dim sql As New StringBuilder()
            '★指定された仕様情報№のブロックを抽出。
            With sql
                .Remove(0, .Length)
                ...
                '.AppendLine("     INNER JOIN " & MBOM_DB_NAME & ".dbo.T_SHISAKU_EVENT_BASE BASE ")
                .AppendLine("     INNER JOIN " & MBOM_DB_NAME & ".dbo.T_SHISAKU_EVENT_EBOM_KANSHI BASE ")
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriByBlock(ByVal shisakuEventCode As String, ByVal blockNo As String) As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseByBlock
            Dim sql As New StringBuilder()
            '★指定された仕様情報№のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAri2(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBase2
            Dim sql As New StringBuilder()
            '★指定された仕様情報№のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAri2NoBuhin(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBase2NoBuhin
            Dim sql As New StringBuilder()
            '★指定された仕様情報№のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAri2ByBlock(ByVal shisakuEventCode As String, ByVal BlockNo As String) As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBase2ByBlock
            Dim sql As New StringBuilder()
            '★指定された仕様情報№のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriOLD(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseOLD
            Dim sql As New StringBuilder()
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriOLDNoBuhin(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseOLDNoBuhin
            Dim sql As New StringBuilder()
            '★指定された仕様情報№の-1のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriOLDByBlock(ByVal shisakuEventCode As String, ByVal blockNo As String) As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseOLDByBlock
            Dim sql As New StringBuilder()
            '★指定された仕様情報№の-1のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriOLD2(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseOLD2
            Dim sql As New StringBuilder()
            '★指定された仕様情報№の-1のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriOLD2NoBuhin(ByVal shisakuEventCode As String, Optional ByVal HyojiJunNo As String = "") As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseOLD2NoBuhin
            Dim sql As New StringBuilder()
            '★指定された仕様情報№の-1のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <returns>該当した「A/Lの素情報」</returns>
        ''' <remarks></remarks>
        Public Function FindAlByShisakuEventBaseIroAriOLD2ByBlock(ByVal shisakuEventCode As String, ByVal blockNo As String) As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindAlByShisakuEventBaseOLD2ByBlock
            Dim sql As New StringBuilder()
            '★指定された仕様情報№の-1のブロックを抽出。
            With sql
                .Remove(0, .Length)
        ...
        ''' <remarks></remarks>
        Public Function FindShisakuBlockInstlByShisakuEventBase(ByVal shisakuEventCode As String, ByVal unitKbn As String, ByVal HyojiJunNo As String) As List(Of YakanSekkeiBlockInstlResultVo) Implements YakanSekkeiBlockDao.FindShisakuBlockInstlByShisakuEventBase
            Dim sql As New StringBuilder()
            ...
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT I.*, B.SHISAKU_BLOCK_NAME, E.SHISAKU_GOUSYA BASE_SHISAKU_GOUSYA ")
                .AppendLine("FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_INSTL_EBOM_KANSHI I ")
                .AppendLine(" WITH (NOLOCK, NOWAIT)  ")

                .AppendLine("    INNER JOIN " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_EBOM_KANSHI B ")
                ...
                '/*** 20140911 CHANGE START ***/
                '.AppendLine("WHERE E.SHISAKU_EVENT_CODE = @Value ")
                '.AppendLine(String.Concat(String.Concat(" AND E.HYOJIJUN_NO = ", HyojiJunNo), " "))
                .AppendLine("WHERE E.SHISAKU_EVENT_CODE = @ShisakuEventCode ")
                ' .AppendLine(String.Concat(String.Concat(" AND E.HYOJIJUN_NO = ", HyojiJunNo), " "))
                .AppendLine(" AND E.HYOJIJUN_NO = @HyojiJunNo ")
                'If unitKbn <> "S" Then
                '    If unitKbn = "M" Then
                '        .AppendLine("        AND B.UNIT_KBN <> 'T' ")
                '    Else
                '        .AppendLine("        AND B.UNIT_KBN <> 'M' ")
                '    End If
                'End If
                If unitKbn <> "S" Then
                ...
                .AppendLine("        (SELECT MAX(SHISAKU_BLOCK_NO_KAITEI_NO) FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_EBOM_KANSHI WITH (NOLOCK, NOWAIT) ")
                ...
                .AppendLine("    AND EXISTS (SELECT * FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_BUHIN_EDIT_INSTL_EBOM_KANSHI WITH (NOLOCK, NOWAIT) ")
                .AppendLine("        WHERE SHISAKU_EVENT_CODE = I.SHISAKU_EVENT_CODE ")
                .AppendLine("            AND SHISAKU_BUKA_CODE = I.SHISAKU_BUKA_CODE ")
                .AppendLine("            AND SHISAKU_BLOCK_NO = I.SHISAKU_BLOCK_NO ")
            ...
            '/*** 20140911 CHANGE START（パラメータ化） ***/
            'Return db.QueryForList(Of YakanSekkeiBlockInstlResultVo)(sql.ToString(), shisakuEventCode)
            Dim param As New SekkeiBlockAlConditionVo(shisakuEventCode, HyojiJunNo, tmpUnitKbn)
            Return db.QueryForList(Of YakanSekkeiBlockInstlResultVo)(sql.ToString(), param)
            '/*** 20140911 CHANGE END ***/
        End Function
        ...
        ''' <returns>該当した「試作設計ブロックINSTL情報」</returns>
        ''' <remarks></remarks>
        Public Function FindShisakuBlockInstlByShisakuEventBaseByBlock(ByVal shisakuEventCode As String, ByVal unitKbn As String, ByVal blockNo As String) As List(Of YakanSekkeiBlockInstlResultVo) Implements YakanSekkeiBlockDao.FindShisakuBlockInstlByShisakuEventBaseByBlock
            Dim sql As New StringBuilder()
            '2012/02/16 ユニット区分を抽出条件に追加
            ' > ベース車の、ベース試作イベントコード・ベース号車の選択値用のメソッド
            ' > EventEditBaseCarDaoImpl#FindBlockInstlForLabelValuesBy 
            ...
            With sql
                ...
                .AppendLine(" (SELECT MAX(SHISAKU_BLOCK_NO_KAITEI_NO) FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_INSTL_EBOM_KANSHI WITH (NOLOCK, NOWAIT) ")
                ...
                '20140818 Sakai Add
                '.AppendLine(" ON TMP.SHISAKU_BLOCK_NO = B.SHISAKU_BLOCK_NO ")
                ...
                '/*** 20140911 CHANGE START（パラメータ化） ***/
                '.AppendLine(" WHERE B.SHISAKU_EVENT_CODE = @Value ")
                ...
                '.AppendLine("WHERE E.SHISAKU_EVENT_CODE = @Value ")
                '.AppendLine(String.Concat(String.Concat(" AND I.SHISAKU_BLOCK_NO = '", blockNo), "' "))
                'If unitKbn <> "S" Then
                '    If unitKbn = "M" Then
                '        .AppendLine("        AND B.UNIT_KBN <> 'T' ")
                '    Else
        ...
        ''' <remarks></remarks>
        Public Function FindShisakuBlockUnit(ByVal BlockNo As String, ByVal KaihatsuFugo As String) As Rhac0080Vo Implements YakanSekkeiBlockDao.FindShisakuBlockUnit
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT ")
        ...
        ''' <returns>該当した「ユニット区分」</returns>
        ''' <remarks></remarks>
        Public Function FindShisakuBlockUnitFromSekkeiBlock(ByVal shisakuEventCode As String, ByVal BlockNo As String) As TShisakuSekkeiBlockEbomKanshiVo Implements YakanSekkeiBlockDao.FindShisakuBlockUnitFromSekkeiBlock
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT ")
                .AppendLine("UNIT_KBN ")
                .AppendLine("FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_EBOM_KANSHI WITH (NOLOCK, NOWAIT) ")
                .AppendLine("WHERE ")
            ...
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of TShisakuSekkeiBlockEbomKanshiVo)(sql.ToString(), param)
        End Function
        ...
        Public Function FindShisakuBlockInstlHyoujiJun(ByVal shisakuEventCode As String, _
                                             ByVal ShisakuBlockNo As String) As TShisakuSekkeiBlockInstlEbomKanshiVo Implements YakanSekkeiBlockDao.FindShisakuBlockInstlHyoujiJun
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT ")
            ...
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of TShisakuSekkeiBlockInstlEbomKanshiVo)(sql.ToString(), param)
        End Function
        ...
        Public Function FindShisakuBlockInstlHyoujiJun2(ByVal shisakuEventCode As String, _
                                             ...
                                             ByVal InstlHinban As String) As TShisakuSekkeiBlockInstlEbomKanshiVo Implements YakanSekkeiBlockDao.FindShisakuBlockInstlHyoujiJun2
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT ")
        ...
        ''' <remarks></remarks>
        Function FindByShisakuEventBase(ByVal shisakuEventCode As String) As List(Of TShisakuEventBaseVo) Implements YakanSekkeiBlockDao.FindByShisakuEventBase
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT ")
        ...
        Function FindRHAC2210(ByVal KaihatsuFugo As String, _
                                  ...
                                  ByVal OpCode As String) As List(Of Rhac2210Vo) Implements YakanSekkeiBlockDao.FindRHAC2210
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT ")
        ...
        Function FindRHAC0532(ByVal BuhinNo As String) As Rhac0532Vo Implements YakanSekkeiBlockDao.FindRHAC0532
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT * ")
                ...
                .AppendLine("WHERE ")
                .AppendLine("BUHIN_NO = @BuhinNo AND ")
                .AppendLine("KAITEI_NO = (SELECT MAX(KAITEI_NO) FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0532 WHERE BUHIN_NO = @BuhinNo ) ")
            End With
            Dim param As New Rhac0532Vo
            param.BuhinNo = BuhinNo
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of Rhac0532Vo)(sql.ToString(), param)
        End Function
        Function FindRHAC0533(ByVal BuhinNo As String) As Rhac0533Vo Implements YakanSekkeiBlockDao.FindRHAC0533
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT * ")
                .AppendLine("FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0533 ")
                .AppendLine("WHERE ")
                .AppendLine("BUHIN_NO = @BuhinNo AND ")
                .AppendLine("KAITEI_NO = (SELECT MAX(KAITEI_NO) FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0533 WHERE BUHIN_NO = @BuhinNo ) ")
            End With
            Dim param As New Rhac0533Vo
            param.BuhinNo = BuhinNo
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of Rhac0533Vo)(sql.ToString(), param)
        End Function
        Function FindRHAC0530(ByVal BuhinNo As String) As Rhac0530Vo Implements YakanSekkeiBlockDao.FindRHAC0530
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT * ")
                .AppendLine("FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0530 ")
                .AppendLine("WHERE ")
                .AppendLine("BUHIN_NO = @BuhinNo AND ")
                .AppendLine("KAITEI_NO = (SELECT MAX(KAITEI_NO) FROM " & RHACLIBF_DB_NAME & ".dbo.RHAC0530 WHERE BUHIN_NO = @BuhinNo ) ")
            End With
            Dim param As New Rhac0530Vo
            param.BuhinNo = BuhinNo
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of Rhac0530Vo)(sql.ToString(), param)
        End Function
        ...
        Function FindRHAC0532AndRHAC0700(ByVal BuhinNo As String) As YakanSekkeiGetForCreateTsuchishoAndZairyouVo Implements YakanSekkeiBlockDao.FindRHAC0532AndRHAC0700
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT")
                .AppendLine("  T1.ZAIRYO_KIJUTSU ZAIRYO_KIJUTSU")
                .AppendLine("  , T1.BANKO_SURYO BANKO_SURYO")
                .AppendLine("  , T3.ZUMEN_NO ZUMEN_NO")
                .AppendLine("  , T3.ZUMEN_KAITEI_NO ZUMEN_KAITEI_NO")
                .AppendLine("  , T3.TSUCHISHO_NO TSUCHISHO_NO ")
                .AppendLine("FROM")
                .AppendLine("  " & RHACLIBF_DB_NAME & ".dbo.RHAC0532 AS T1 ")
                .AppendLine("  LEFT JOIN " & RHACLIBF_DB_NAME & ".dbo.RHAC0700 AS T3 ")
                .AppendLine("    ON T1.ZUMEN_NO = T3.ZUMEN_NO ")
                .AppendLine("    AND T1.ZUMEN_KAITEI_NO = T3.ZUMEN_KAITEI_NO ")
                .AppendLine("    AND T3.HAISI_DATE = 99999999 ")
                .AppendLine("WHERE")
                .AppendLine("  T1.BUHIN_NO = @BuhinNo ")
                .AppendLine("  AND KAITEI_NO = ( ")
                .AppendLine("    SELECT ")
                .AppendLine("      MAX(T2.KAITEI_NO) ")
                .AppendLine("    FROM ")
                .AppendLine("      " & RHACLIBF_DB_NAME & ".dbo.RHAC0532 AS T2 ")
                .AppendLine("    WHERE")
                .AppendLine("      T1.BUHIN_NO = T2.BUHIN_NO ")
                .AppendLine("  ) ")
                .AppendLine("  AND T1.HAISI_DATE = 99999999 ")
            End With
            Dim param As New YakanSekkeiGetForCreateTsuchishoAndZairyouVo
            param.BuhinNo = BuhinNo
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of YakanSekkeiGetForCreateTsuchishoAndZairyouVo)(sql.ToString(), param)
        End Function
        Function FindRHAC0533AndRHAC0700(ByVal BuhinNo As String) As YakanSekkeiGetForCreateTsuchishoAndZairyouVo Implements YakanSekkeiBlockDao.FindRHAC0533AndRHAC0700
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT")
                ...
                .AppendLine("  , T3.TSUCHISHO_NO TSUCHISHO_NO ")
                .AppendLine("FROM")
                .AppendLine("  " & RHACLIBF_DB_NAME & ".dbo.RHAC0533 AS T1 ")
                .AppendLine("  LEFT JOIN " & RHACLIBF_DB_NAME & ".dbo.RHAC0700 AS T3 ")
                .AppendLine("    ON T1.ZUMEN_NO = T3.ZUMEN_NO ")
                .AppendLine("    AND T1.ZUMEN_KAITEI_NO = T3.ZUMEN_KAITEI_NO ")
                .AppendLine("    AND T3.HAISI_DATE = 99999999 ")
                ...
                .AppendLine("      MAX(T2.KAITEI_NO) ")
                .AppendLine("    FROM ")
                .AppendLine("      " & RHACLIBF_DB_NAME & ".dbo.RHAC0533 AS T2 ")
                .AppendLine("    WHERE")
                .AppendLine("      T1.BUHIN_NO = T2.BUHIN_NO ")
                .AppendLine("  ) ")
                .AppendLine("  AND T1.HAISI_DATE = 99999999 ")
            ...
            Return db.QueryForObject(Of YakanSekkeiGetForCreateTsuchishoAndZairyouVo)(sql.ToString(), param)
        End Function
        Function FindRHAC0530AndRHAC0700(ByVal BuhinNo As String) As YakanSekkeiGetForCreateTsuchishoAndZairyouVo Implements YakanSekkeiBlockDao.FindRHAC0530AndRHAC0700
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine("SELECT")
                ...
                .AppendLine("  , T3.TSUCHISHO_NO TSUCHISHO_NO ")
                .AppendLine("FROM")
                .AppendLine("  " & RHACLIBF_DB_NAME & ".dbo.RHAC0530 AS T1 ")
                .AppendLine("  LEFT JOIN " & RHACLIBF_DB_NAME & ".dbo.RHAC0700 AS T3 ")
                .AppendLine("    ON T1.ZUMEN_NO = T3.ZUMEN_NO ")
                .AppendLine("    AND T1.ZUMEN_KAITEI_NO = T3.ZUMEN_KAITEI_NO ")
                .AppendLine("    AND T3.HAISI_DATE = 99999999 ")
                ...
                .AppendLine("      MAX(T2.KAITEI_NO) ")
                .AppendLine("    FROM ")
                .AppendLine("      " & RHACLIBF_DB_NAME & ".dbo.RHAC0530 AS T2 ")
                .AppendLine("    WHERE")
                .AppendLine("      T1.BUHIN_NO = T2.BUHIN_NO ")
                .AppendLine("  ) ")
                .AppendLine("  AND T1.HAISI_DATE = 99999999 ")
        ...
        Function FindByShisakuEvent(ByVal shisakuEventCode As String, _
                                  ...
                                  ByVal KatashikiScd7 As String, _
                                  ByVal ShimukechiCode As String, _
                                  ByVal OpCode As String) As List(Of SekkeiBlockAlResultVo) Implements YakanSekkeiBlockDao.FindByShisakuEvent
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine(" SELECT AL.BLOCK_NO, ")
        ...
        Function FindSekkeiBlock(ByVal shisakuEventCode As String, _
                                 ...
                                 ByVal shisakuBlockNo As String, _
                                 ByVal shisakuBlockNoKaiteiNo As String) As TShisakuSekkeiBlockEbomKanshiVo Implements YakanSekkeiBlockDao.FindSekkeiBlock
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_EBOM_KANSHI BLOCK WITH (NOLOCK, NOWAIT) ")
            ...
            End With
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of TShisakuSekkeiBlockEbomKanshiVo)(sql.ToString())
        End Function
        ...
        Function FindSekkeiBlockInstl(ByVal shisakuEventCode As String, _
                                      ...
                                      ByVal instlHinbanKbn As String) As TShisakuSekkeiBlockInstlEbomKanshiVo Implements YakanSekkeiBlockDao.FindSekkeiBlockInstl
            Dim sql As New StringBuilder()
            With sql
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_INSTL_EBOM_KANSHI BLOCK WITH (NOLOCK, NOWAIT) ")
                .AppendLine(" WHERE BLOCK.SHISAKU_EVENT_CODE = '" & shisakuEventCode & "' AND ")
                .AppendLine("       BLOCK.SHISAKU_BUKA_CODE = '" & shisakuBukaCode & "' AND ")
                .AppendLine("       BLOCK.SHISAKU_BLOCK_NO = '" & shisakuBlockNo & "' AND ")
            ...
            End With
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of TShisakuSekkeiBlockInstlEbomKanshiVo)(sql.ToString())
        End Function
...
#Region "親品番が自給品のデータを削除する"
        ...
        ''' <remarks></remarks>
        Function FindByShisakuEvent(ByVal shisakuEventCode As String) As TShisakuEventEbomKanshiVo Implements YakanSekkeiBlockDao.FindByShisakuEvent
            ...
            Dim db As New EBomDbClient
            Return db.QueryForObject(Of TShisakuEventEbomKanshiVo)(sb.ToString(), shisakuEventCode)
        End Function
        ...
        ''' <remarks></remarks>
        Function FindByShisakuBlockAll(ByVal shisakuEventCode As String) As List(Of TShisakuSekkeiBlockEbomKanshiVo) Implements YakanSekkeiBlockDao.FindByShisakuBlockAll
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT SHISAKU_EVENT_CODE, SHISAKU_BUKA_CODE, ")
                .AppendLine(" SHISAKU_BLOCK_NO, SHISAKU_BLOCK_NO_KAITEI_NO ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_EBOM_KANSHI ")
                .AppendLine(" WHERE ")
                .AppendLine(" SHISAKU_EVENT_CODE = @Value ")
            ...
            Dim db As New EBomDbClient
            Return db.QueryForList(Of TShisakuSekkeiBlockEbomKanshiVo)(sb.ToString(), shisakuEventCode)
        End Function
        ''' <summary>
        ''' 「試作設計ブロック情報」を返す
        ''' </summary>
        ...
        ''' <returns>設計ブロック情報</returns>
        ''' <remarks></remarks>
        Function FindByShisakuBlockAllGroupByBlockNo(ByVal shisakuEventCode As String) As List(Of TShisakuSekkeiBlockEbomKanshiVo) Implements YakanSekkeiBlockDao.FindByShisakuBlockAllGroupByBlockNo
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT  ")
        ...
        ''' <remarks></remarks>
        Function FindByShisakuSekkeiBlockInstl(ByVal shisakuEventCode As String, ByVal shisakuBukaCode As String, ByVal shisakuBlockNo As String) As List(Of TShisakuSekkeiBlockInstlEbomKanshiVo) Implements YakanSekkeiBlockDao.FindByShisakuSekkeiBlockInstl
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_INSTL_EBOM_KANSHI ")
                .AppendLine(" WHERE ")
                .AppendLine(" SHISAKU_EVENT_CODE = @ShisakuEventCode ")
            ...
            Dim db As New EBomDbClient
            Return db.QueryForList(Of TShisakuSekkeiBlockInstlEbomKanshiVo)(sb.ToString(), param)
        End Function
        ...
        ''' <remarks></remarks>
        Function FindByShisakuBuhinEditInstl(ByVal shisakuEventCode As String, ByVal shisakuBukaCode As String, ByVal shisakuBlockNo As String, ByVal instlHinbanHyoujiJun As Integer) As List(Of TShisakuBuhinEditInstlEbomKanshiVo) Implements YakanSekkeiBlockDao.FindByShisakuBuhinEditInstl
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT B.* ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_INSTL_EBOM_KANSHI A ")
                .AppendLine(" INNER JOIN " & MBOM_DB_NAME & ".dbo.T_SHISAKU_BUHIN_EDIT_INSTL_EBOM_KANSHI B ")
        ...
        ''' <param name="shisakuBlockNo">試作ブロックNo</param>
        ''' <remarks></remarks>
        Sub DeleteByShisakuBuhinEditInstl(ByVal shisakuEventCode As String, ByVal shisakuBukaCode As String, ByVal shisakuBlockNo As String) Implements YakanSekkeiBlockDao.DeleteByShisakuBuhinEditInstl
            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" DELETE FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_INSTL_EBOM_KANSHI ")
            ...
            With sb1
                .Remove(0, .Length)
                .AppendLine(" DELETE FROM " & MBOM_DB_NAME & ".dbo.T_SHISAKU_SEKKEI_BLOCK_EBOM_KANSHI ")
                .AppendLine(" WHERE SHISAKU_EVENT_CODE = @ShisakuEventCode ")
                .AppendLine(" AND SHISAKU_BUKA_CODE = @ShisakuBukaCode ")
                .AppendLine(" AND SHISAKU_BLOCK_NO = @ShisakuBlockNo ")
            End With
            Dim param2 As New TShisakuSekkeiBlockEbomKanshiVo
