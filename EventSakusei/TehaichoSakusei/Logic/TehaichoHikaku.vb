...
Namespace TehaichoSakusei.Logic
    ...
    Public Class TehaichoHikaku
        ...
        Private HikakuImpl As TehaichoHikakuDao
        Private SakuseiImpl As TehaichoSakuseiDao
        ...
        Public Sub New(ByVal BuhinEditVoList As List(Of TShisakuBuhinEditVo), _
            ...
            HikakuImpl = New TehaichoHikakuDaoImpl
            SakuseiImpl = New TehaichoSakuseiDaoImpl
            _shisakuGroup = shisakuGroup
        ...
        Public Sub Hikaku()
            ...
            For Each Vo As TShisakuBuhinEditVo In _BuhinEditVoList
                ...
                'ベースとなる部品編集情報を検索する'
                Dim GousyaList As New List(Of TShisakuBuhinEditGousyaTmpVo)
                ...
                If Vo.Saishiyoufuka.TrimEnd <> "" Then
                    ...
                    For Each gVo As TShisakuBuhinEditGousyaTmpVo In GousyaList
        ...
        Private Sub CreateBaseTmp()
            ...
            Dim BaseTmpVoList As New List(Of TehaichoBuhinEditTmpVo)
            ...
            If _Eventvo.BlockAlertKind = 2 And _Eventvo.KounyuShijiFlg = "0" Then
                ...
                For Each vo As TehaichoBuhinEditTmpVo In BaseTmpVoList
            ...
            'マージする'
            Dim NewBaseTmpVoList As New List(Of TehaichoBuhinEditTmpVo)
        ...
        Private Function InsuCheck(ByVal BuhinEditVo As TShisakuBuhinEditVo, ByVal BuhinEditBaseVo As TShisakuBuhinEditBaseVo) As Boolean
            ...
            Dim BuhinEditBaseInstlListVo As New List(Of TShisakuBuhinEditGousyaTmpVo)
            ...
            Dim BuhinEditInstlListVo As New List(Of TShisakuBuhinEditGousyaTmpVo)
            ...
            If BuhinEditBaseInstlListVo.Count = 0 Then
                BaseInsuSuryo = 0
            Else
                For Each baseInstlVo As TShisakuBuhinEditGousyaTmpVo In BuhinEditBaseInstlListVo
            ...
            If BuhinEditInstlListVo.Count = 0 Then
                EditInsuSuryo = 0
            Else
                For Each editInstlVo As TShisakuBuhinEditGousyaTmpVo In BuhinEditInstlListVo
            ...
            If EditInsuSuryo = BaseInsuSuryo Then
                ...
                If changeFlag Then
                    ...
                    'ベース側の員数をFで'
                    For Each gVo As TShisakuBuhinEditGousyaTmpVo In BuhinEditBaseInstlListVo
                        '員数と号車はベース、それ以外は前回で追加'
                        Dim NewGousya As New TShisakuBuhinEditGousyaTmpVo
                    ...
                    For index As Integer = 0 To BuhinEditInstlListVo.Count - 1
                        ...
                        Dim NewGousyaVo As New TShisakuBuhinEditGousyaTmpVo
                ...
                Else
                    ...
                    '    For Each gVo As TShisakuBuhinEditGousyaTmpVo In BuhinEditInstlListVo
                    '        SqlCreateGousyaEdit(gVo, 1)
                    '    Next
                    'End If
                End If
            ...
            Using insert As New SqlAccess(g_kanrihyoIni(DB_KEY_EBOM))
                ...
                Select Case Flag
                    Case 0
                        '変更無し(更新)'
                        With sql
                            .AppendLine("UPDATE " & MBOM_DB_NAME & ".dbo.T_SHISAKU_BUHIN_EDIT_TMP ")
                            .AppendLine("SET ")
        ...
        ''' <remarks></remarks>
        Private Sub SqlCreateGousyaEdit(ByVal BuhinEditGousyaTmp As TShisakuBuhinEditGousyaTmpVo, ByVal flag As Integer)
            sql = ""
            Dim aDate As New ShisakuDate
            Dim CreatedUserId As String = LoginInfo.Now.UserId
            Dim CreatedUserDate As String = aDate.CurrentDateDbFormat
