...
Namespace TehaichoSakusei.Dao
    Public Interface TehaichoHikakuDao
        '比較織込み用のインターフェース'
...
#Region "取得する処理(Find)"
        ...
        ''' <remarks></remarks>
        Function FindByGousyaTmp(ByVal BuhinEditVo As TShisakuBuhinEditVo) As List(Of TShisakuBuhinEditGousyaTmpVo)
        ...
        ''' <remarks></remarks>
        Function FindByGousyaHyoujiJun(ByVal GousyaVo As TShisakuBuhinEditGousyaTmpVo) As Integer
        ...
        Function FindByBaseInsu(ByVal shisakuEventCode As String, _
                                ByVal shisakuBukaCode As String, _
                                ByVal shisakuBlockNo As String, _
                                ByVal buhinNoHyoujiJun As Integer) As List(Of TShisakuBuhinEditGousyaTmpVo)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function FindByBaseTmpVoList(ByVal shisakuEventCode As String, ByVal shisakuGroup As String, ByVal JikyuFlg As Boolean) As List(Of TehaichoBuhinEditTmpVo)
...
#Region "更新する処理(Update)"
        ...
        ''' <remarks></remarks>
        Sub UpdateByGousyaTmpNotChange(ByVal GousyaTmpVo As TShisakuBuhinEditGousyaTmpVo, ByVal gousyaNo As Integer)
        ...
        ''' <remarks></remarks>
        Sub UpdateByBuhinTmpSyukeiTenkai(ByVal shisakuBuhinTmp As List(Of TShisakuBuhinEditTmpVo), ByVal SeihinKbn As String)
        ...
        ''' <param name="gousyaNo">号車No</param>
        ''' <remarks></remarks>
        Sub UpdateByGousyaTmpInsuUp(ByVal GousyaTmpVo As TShisakuBuhinEditGousyaTmpVo, ByVal gousyaNo As Integer, ByVal insu As Integer)
...
#Region "追加する処理(Insert)"
        ...
        ''' <remarks></remarks>
        Sub InsertByGousyaTMPHikakuKekka(ByVal gousyaTmpvo As TShisakuBuhinEditGousyaTmpVo, ByVal gousyaHyoujijun As Integer)
        ...
        ''' <param name="gousyaTmpvo">部品表編集号車情報VO</param>
        ''' <remarks></remarks>
        Sub InsertByGousyaTMPInsuUp(ByVal gousyaTmpvo As TShisakuBuhinEditGousyaTmpVo, ByVal gousyaHyoujijun As Integer, ByVal insu As Integer)
        ...
        ''' <remarks></remarks>
        Sub InsertByBuhinEditTMPBase(ByVal shisakuBuhinEditvo As List(Of TehaichoBuhinEditTmpVo), ByVal seihinKbn As String)
        ...
        ''' <param name="gousyaTmpvo">部品表編集号車情報VO</param>
        ''' <remarks></remarks>
        Sub InsertByGousyaTMPBase(ByVal gousyaTmpvo As List(Of TehaichoBuhinEditTmpVo))
