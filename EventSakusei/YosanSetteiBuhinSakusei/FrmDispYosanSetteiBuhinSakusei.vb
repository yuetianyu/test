...
Namespace YosanSetteiBuhinSakusei
    ...
    Public Class frmDispYosanSetteiBuhinSakusei : Implements Observer

        Private tehaiSubject As YosanSetteiBuhinSakusei.Logic.YosansetteiBuhinSakusei
        Private IsSuspendTehaiValueChanged As Boolean
        Private ReadOnly aInputWatcher As InputWatcher


        Private Vo As List(Of YosansetteiBuhinSakuseiVo)
        ...
        Public Sub New(ByVal eventCode As String)
            ...
            tehaiSubject = New Logic.YosanSetteiBuhinSakusei(LoginInfo.Now, eventCode)
...
#Region "ボタンの処理"
        ...
        Private Sub btnADD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnADD.Click
            ...
            If cmbGroupNo.SelectedIndex = -1 Then
                cmbGroupNo.BackColor = Color.Red
                cmbGroupNo.Focus()

                ComFunc.ShowErrMsgBox("グループNoを入力してください。")
                Return
            End If
            ...
            If frm01Kakunin.ConfirmOkCancel("予算単価設定表を作成します") <> MsgBoxResult.Ok Then
                Return
            End If
