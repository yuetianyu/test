...
Namespace YosanSetteiBuhinSakusei.Dao
    Public Class YosanSetteiBuhinHikakuDaoImpl : Inherits DaoEachFeatureImpl
        Implements YosanSetteiBuhinHikakuDao

        Private _Eventvo As TShisakuEventVo

        Public WriteOnly Property EventVo() As TShisakuEventVo Implements YosanSetteiBuhinHikakuDao.EventVo
...
#Region "比較織込みに使用するFind"
        ...
        Public Function FindByTsuikaHinban(ByVal shisakuEventCode As String, _
                                           ...
                                           ByVal BuhinNoKbn As String, _
                                                 ...
                                                 Optional ByVal BaseBuhinFlag As String = Nothing) As List(Of TShisakuBuhinEditBaseVo) Implements YosanSetteiBuhinHikakuDao.FindByTsuikaHinban
        ...
        ''' <returns>試作部品表編集ベース情報</returns>
        Public Function FindByTsuikaHinban(ByVal param As TShisakuBuhinEditBaseVo) As List(Of TShisakuBuhinEditBaseVo) Implements YosanSetteiBuhinHikakuDao.FindByTsuikaHinban
        ...
        ''' <remarks></remarks>
        Public Function FindByGousyaTmp(ByVal BuhinEditVo As TShisakuBuhinEditVo) As List(Of TYosanSetteiGousyaTmpVo) Implements YosanSetteiBuhinHikakuDao.FindByGousyaTmp
            Dim sql As String = _
            " SELECT  " _
            ...
            Return db.QueryForList(Of TYosanSetteiGousyaTmpVo)(sql, param)
        End Function
        ...
        ''' <returns>部品編集号車情報TMP情報</returns>
        ''' <remarks></remarks>
        Public Function FindByGousyaHyoujiJun(ByVal GousyaVo As TYosanSetteiGousyaTmpVo) As Integer Implements YosanSetteiBuhinHikakuDao.FindByGousyaHyoujiJun
            Dim sql As String = _
            " SELECT * " _
            & " FROM " _
            & " " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_GOUSYA_TMP TG" _
            & " WHERE " _
            ...
            & " SELECT MAX ( CONVERT ( INT,COALESCE ( SHISAKU_BLOCK_NO_KAITEI_NO,'' ) ) ) AS SHISAKU_BLOCK_NO_KAITEI_NO " _
            & " FROM " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_GOUSYA_TMP " _
            ...
            vo = db.QueryForObject(Of TYosanSetteiGousyaTmpVo)(sql, param)
        ...
        ''' <remarks></remarks>
        Public Function FindByTsuikaHinbanTmp(ByVal BaseVo As TShisakuBuhinEditVo) As Boolean Implements YosanSetteiBuhinHikakuDao.FindByTsuikaHinbanTmp
            Dim sql As String = _
            " SELECT  * " _
            & " FROM " _
            & " " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP " _
            & " WHERE " _
            ...
            vo = db.QueryForObject(Of TYosanSetteiBuhinTmpVo)(sql, param)
        ...
        Public Function FindByBaseInsu(ByVal shisakuEventCode As String, _
                                ByVal shisakuBukaCode As String, _
                                ByVal shisakuBlockNo As String, _
                                ByVal buhinNoHyoujiJun As Integer) As List(Of TYosanSetteiGousyaTmpVo) Implements YosanSetteiBuhinHikakuDao.FindByBaseInsu
            Dim sql As String = _
            "SELECT " _
        ...
        Public Function FindByInsuSuryo(ByVal shisakuEventCode As String, _
                                ByVal shisakuBukaCode As String, _
                                ByVal shisakuBlockNo As String, _
                                ByVal buhinNoHyoujiJun As Integer) As List(Of TYosanSetteiGousyaTmpVo) Implements YosanSetteiBuhinHikakuDao.FindByInsuSuryo
            Dim sql As String = _
            "SELECT " _
            & " SBI.SHISAKU_EVENT_CODE, " _
            & " SBI.SHISAKU_BUKA_CODE, " _
        ...
        Public Function CheckInsuUpDown(ByVal shisakuEventCode As String, _
                                ...
                                ByVal baseFlg As Boolean) As String Implements YosanSetteiBuhinHikakuDao.CheckInsuUpDown
        ...
        Public Function FindByNewBuhinNoHyoujiJun(ByVal shisakuEventCode As String, _
                                ByVal shisakuBukaCode As String, _
                                ByVal shisakuBlockNo As String) As Integer Implements YosanSetteiBuhinHikakuDao.FindByNewBuhinNoHyoujiJun
            Dim sql As String = _
            "SELECT * " _
            & " FROM " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP TMP " _
            & " WHERE " _
            ...
            & " FROM " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP " _
            ...
            vo = db.QueryForObject(Of TYosanSetteiBuhinTmpVo)(sql)
        ...
        Public Function FindByNewGousyaBuhinNoHyoujiJun(ByVal shisakuEventCode As String, _
                                ByVal shisakuBukaCode As String, _
                                ByVal shisakuBlockNo As String) As Integer Implements YosanSetteiBuhinHikakuDao.FindByNewGousyaBuhinNoHyoujiJun
            Dim sql As String = _
            "SELECT * " _
            & " FROM " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_GOUSYA_TMP TMP " _
            & " WHERE " _
            & " TMP.SHISAKU_EVENT_CODE = '" & shisakuEventCode & "'" _
            & " AND TMP.SHISAKU_BUKA_CODE = '" & shisakuBukaCode & "'" _
            & " AND TMP.SHISAKU_BLOCK_NO = '" & shisakuBlockNo & "'" _
            ...
            vo = db.QueryForObject(Of TYosanSetteiGousyaTmpVo)(sql)
        ...
        Public Function FindBySumInsu(ByVal shisakuEventCode As String, _
                                ByVal shisakuBukaCode As String, _
                                ByVal shisakuBlockNo As String, _
                                ByVal buhinNoHyoujiJun As Integer) As Integer Implements YosanSetteiBuhinHikakuDao.FindBySumInsu
            Dim sql As String = _
        ...
        Public Function FindBySumInsuTmp(ByVal shisakuEventCode As String, _
                                ByVal shisakuBukaCode As String, _
                                ByVal shisakuBlockNo As String, _
                                ByVal buhinNoHyoujiJun As Integer) As Integer Implements YosanSetteiBuhinHikakuDao.FindBySumInsuTmp
            Dim sql As String = _
            "SELECT SUM(INSU_SURYO) INSU_SURYO " _
        ...
        ''' <remarks></remarks>
        Public Function FindByKaihatsuFugo(ByVal shisakuEventCode As String) As String Implements YosanSetteiBuhinHikakuDao.FindByKaihatsuFugo
            Dim sql As String = _
            " SELECT * " _
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function FindByGousyaList(ByVal shisakuEventCode As String, ByVal shisakuGroup As String) Implements YosanSetteiBuhinHikakuDao.FindByGousyaList
            Dim sql As String = _
            " SELECT * " _
        ...
        Public Function FindByBuhinEditGousya(ByVal shisakuEventCode As String, _
                                              ...
                                              ByVal BuhinNoHyoujiJun As Integer) As List(Of TYosanSetteiGousyaTmpVo) Implements YosanSetteiBuhinHikakuDao.FindByBuhinEditGousya
            Dim sql As String = _
            " SELECT * " _
            & " FROM " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_GOUSYA_TMP G " _
            & " WHERE " _
            ...
            Dim db As New EBomDbClient
            Return db.QueryForList(Of TYosanSetteiGousyaTmpVo)(sql)
        End Function
        ...
        Public Function FindByBuhinEditGousyaBase(ByVal shisakuEventCode As String, _
                                                 ByVal shisakuBukaCode As String, _
                                                 ByVal shisakuBlockNo As String, _
                                                 ByVal BuhinNoHyoujiJun As Integer) As List(Of TYosanSetteiGousyaTmpVo) Implements YosanSetteiBuhinHikakuDao.FindByBuhinEditGousyaBase

            Dim sb As New StringBuilder
            With sb
                .Remove(0, .Length)
                .AppendLine(" SELECT * ")
                .AppendLine(" FROM " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_GOUSYA_TMP BEI ")
                .AppendLine(" WHERE ")
            ...
            Dim db As New EBomDbClient
            Return db.QueryForList(Of TYosanSetteiGousyaTmpVo)(sb.ToString)
        End Function
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function FindByBaseTmpVoList(ByVal shisakuEventCode As String, ByVal shisakuGroup As String, ByVal JikyuFlg As Boolean) As List(Of YosanSetteiBuhinEditTmpVo) Implements YosanSetteiBuhinHikakuDao.FindByBaseTmpVoList
            ...
            For Each BaseVo As TShisakuEventBaseVo In BaseList
                ...
                For Each sekkeiBlockInstlVo As TShisakuSekkeiBlockInstlVo In sekkeiBlockInstlList
                    'If Not StringUtil.Equals("642A", sekkeiBlockInstlVo.ShisakuBlockNo) Then
                    '    Continue For
                    'End If
                    ...
                    Dim buhinEditList As List(Of YosanSetteiBuhinEditTmpVo) = db.QueryForList(Of YosanSetteiBuhinEditTmpVo)(sql3.ToString)
...
#Region "更新する処理"
        ...
        ''' <remarks></remarks>
        Public Sub UpdateByBuhinTmpNotChange(ByVal BuhinEditVo As TShisakuBuhinEditVo) Implements YosanSetteiBuhinHikakuDao.UpdateByBuhinTmpNotChange
            Dim sql As String = _
        ...
        ''' <remarks></remarks>
        Public Sub UpdateByGousyaTmpNotChange(ByVal GousyaVo As TYosanSetteiGousyaTmpVo, _
                                              ByVal gousyaNo As Integer) Implements YosanSetteiBuhinHikakuDao.UpdateByGousyaTmpNotChange
            Dim sql As String = _
        ...
        ''' <remarks></remarks>
        Public Sub UpdateByBuhinTmpSyukeiTenkai(ByVal shisakuTmp As List(Of TYosanSetteiBuhinTmpVo), ByVal SeihinKbn As String) Implements YosanSetteiBuhinHikakuDao.UpdateByBuhinTmpSyukeiTenkai
            Dim db As New EBomDbClient
            Dim aDate As New ShisakuDate

            Dim impl As YosanSetteiBuhinSakuseiDao = New YosanSetteiBuhinSakuseiDaoImpl
            ...
            Using update As New SqlAccess(g_kanrihyoIni(DB_KEY_EBOM))
                ...
                For index As Integer = 0 To shisakuTmp.Count - 1
                    ...
                    Dim buhinNoOyaVo As New TYosanSetteiBuhinTmpVo
                    Dim buhinEditTmpVo As New TYosanSetteiBuhinTmpVo
                    ...
                    Dim sql As New System.Text.StringBuilder
                    With sql
                        .AppendFormat(" UPDATE {0}.dbo.T_YOSAN_SETTEI_BUHIN_TMP ", MBOM_DB_NAME)
                        .AppendLine(" SET ")
        ...
        Public Sub UpdateByBuhinTmpIkanshaKaishu(ByVal eventCode As String, ByVal listCode As String) Implements YosanSetteiBuhinHikakuDao.UpdateByBuhinTmpIkanshaKaishu
            Using update As New SqlAccess(g_kanrihyoIni(DB_KEY_EBOM))
                update.Open()
                update.BeginTransaction()
                Dim sql As New System.Text.StringBuilder
        ...
        ''' <remarks></remarks>
        Public Sub UpdateByBuhinTmpTsuikaHinban(ByVal shisakuTmp As TShisakuBuhinEditVo, ByVal SeihinKbn As String) Implements YosanSetteiBuhinHikakuDao.UpdateByBuhinTmpTsuikaHinban
            Dim sql As String = _
            " UPDATE " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP " _
            & " SET " _
        ...
        ''' <remarks></remarks>
        Public Sub UpdateByBuhinTmpInsuUp(ByVal BuhinTmp As TShisakuBuhinEditVo, ByVal SeihinKbn As String) Implements YosanSetteiBuhinHikakuDao.UpdateByBuhinTmpInsuUp
            Dim sql As String = _
            " UPDATE " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP " _
            & " SET " _
            ...
            & " SELECT MAX ( CONVERT ( INT,COALESCE ( BUHIN_NO_HYOUJI_JUN,'' ) ) ) AS BUHIN_NO_HYOUJI_JUN " _
            & " FROM " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP " _
            & " WHERE SHISAKU_EVENT_CODE = " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP.SHISAKU_EVENT_CODE " _
            & " AND SHISAKU_BUKA_CODE = " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP.SHISAKU_BUKA_CODE " _
            & " AND SHISAKU_BLOCK_NO = " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP.SHISAKU_BLOCK_NO) + 1 " _
            & " TEHAI_KIGOU = @TehaiKigou, " _
            & " NOUBA = @Nouba, " _
            & " KYOUKU_SECTION = @KyoukuSection, " _
            & " HENKATEN = @Henkaten " _
        ...
        ''' <remarks></remarks>
        Public Sub UpdateByGousyaTmpInsuUp(ByVal GousyaTmpVo As TYosanSetteiGousyaTmpVo, ByVal gousyaNo As Integer, ByVal insu As Integer) Implements YosanSetteiBuhinHikakuDao.UpdateByGousyaTmpInsuUp
...
#Region "追加する処理"
        ...
        Public Sub InsertByBuhinTmpNotChange(ByVal BuhinEditVo As TShisakuBuhinEditVo, ByVal seihinKbn As String, _
                                 ByVal shisakuListCode As String) Implements YosanSetteiBuhinHikakuDao.InsertByBuhinTmpNotChange
            Dim sql As String = _
            " INSERT INTO " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP (" _
            ...
            Dim param As New TYosanSetteiBuhinTmpVo
            Dim paramImpl As YosanSetteiBuhinSakuseiDao = New YosanSetteiBuhinSakuseiDaoImpl
        ...
        ''' <remarks></remarks>
        Public Sub InsertByGousyaTMPHikakuKekka(ByVal gousyaTmpvo As TYosanSetteiGousyaTmpVo, _
                                                 ByVal gousyaHyoujijun As Integer) Implements YosanSetteiBuhinHikakuDao.InsertByGousyaTMPHikakuKekka
            Dim sql As String = _
            ...
            Vo = db.QueryForObject(Of TYosanSetteiGousyaTmpVo)(sspl, param)
        ...
        Public Sub InsertByBuhinTmpTsuikaHinban(ByVal BuhinEditvo As TShisakuBuhinEditVo, ByVal seihinKbn As String, _
                                 ByVal shisakuListCode As String) Implements YosanSetteiBuhinHikakuDao.InsertByBuhinTmpTsuikaHinban
            Dim sql As String = _
            " INSERT INTO " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP (" _
            & " SHISAKU_EVENT_CODE, " _
            & " SHISAKU_BUKA_CODE, " _
        ...
        Public Sub InsertByBuhinTmpInsuUp(ByVal BuhinEditvo As TShisakuBuhinEditVo, ByVal seihinKbn As String, _
                                 ByVal shisakuListCode As String) Implements YosanSetteiBuhinHikakuDao.InsertByBuhinTmpInsuUp
            Dim sql As String = _
            " INSERT INTO " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_BUHIN_TMP (" _
            & " SHISAKU_EVENT_CODE, " _
            & " SHISAKU_BUKA_CODE, " _
        ...
        ''' <param name="gousyaTmpvo">部品表編集号車情報VO</param>
        ''' <remarks></remarks>
        Public Sub InsertByGousyaTMPInsuUp(ByVal gousyaTmpvo As TYosanSetteiGousyaTmpVo, ByVal gousyaHyoujijun As Integer, ByVal insu As Integer) Implements YosanSetteiBuhinHikakuDao.InsertByGousyaTMPInsuUp
            Dim sql As String = _
            " INSERT INTO " & MBOM_DB_NAME & ".dbo.T_YOSAN_SETTEI_GOUSYA_TMP ( " _
            & " SHISAKU_EVENT_CODE, " _
            & " SHISAKU_BUKA_CODE, " _
        ...
        ''' <remarks></remarks>
        Public Sub InsertByBuhinEditTmpBase(ByVal BuhinEditTMPvo As List(Of YosanSetteiBuhinEditTmpVo), _
                                            ByVal seihinKbn As String) Implements YosanSetteiBuhinHikakuDao.InsertByBuhinEditTMPBase
        ...
        ''' <param name="gousyaTmpvo">部品表編集号車情報VO</param>
        ''' <remarks></remarks>
        Public Sub InsertByGousyaTMP(ByVal gousyaTmpvo As List(Of YosanSetteiBuhinEditTmpVo)) Implements YosanSetteiBuhinHikakuDao.InsertByGousyaTMPBase
...
#End Region
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function getBlockList(ByVal eventCode As String) As List(Of TShisakuSekkeiBlockVo) Implements YosanSetteiBuhinHikakuDao.getBlockList
            Dim sql As New System.Text.StringBuilder
            With sql
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function FindTShisakuBuhinEdit(ByVal eventCode As String, ByVal blockNo As String, ByVal kaiteiNo As String) As List(Of TShisakuBuhinEditVo) Implements YosanSetteiBuhinHikakuDao.FindTShisakuBuhinEdit
            Dim sql As New System.Text.StringBuilder
            With sql
