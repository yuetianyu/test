...
Namespace ShisakuBuhinEdit.Logic.Detect
    ...
    Public Class DetectLatestStructureImpl
        ...
        ''' <remarks></remarks>
        Public Sub New(ByVal blockKeyVo As TShisakuSekkeiBlockVo)
            Me.New(blockKeyVo, New Rhac0532DaoImpl, New Rhac0533DaoImpl, New Rhac0530DaoImpl, New TShisakuSekkeiBlockInstlDaoImpl, New TShisakuBuhinEditDaoImpl)
        End Sub
        ...
        ''' <param name="editDao">試作部品編集情報Dao</param>
        ''' <remarks></remarks>
        Public Sub New(ByVal blockKeyVo As TShisakuSekkeiBlockVo, _
                       ...
                       ByVal editDao As TShisakuBuhinEditDao)

            Me.blockKeyVo = blockKeyVo
            Me.shisakuEventCode = blockKeyVo.ShisakuEventCode
            ...
            EzUtil.AssertParameterIsNotNull(blockKeyVo.ShisakuEventCode, "blockKeyVo.ShisakuEventCode")
        ...
        ''' <remarks></remarks>
        Public Function Compute(ByVal buhinNo As String, ByVal buhinNoKbn As String, ByVal IsInstlHinban As Boolean) As StructureResult Implements DetectLatestStructure.Compute
        ...
        ''' <returns>構成の情報</returns>
        ''' <remarks></remarks>
        Public Function Compute(ByVal buhinNo As String, ByVal buhinNoKbn As String, ByVal IsInstlHinban As Boolean, ByVal targetTable As String, Optional ByVal KaihatsuFugo As String = "", Optional ByVal shisakuEventCode As String = "") As StructureResult Implements DetectLatestStructure.Compute
            If StringUtil.IsEmpty(buhinNo) Then
                Return StructureResult.NewNotExist(buhinNo, buhinNoKbn)
            End If
        ...
        Private Function DetectShisakuSekkeiBlockInstl(ByVal buhinNo As String, ByVal buhinNoKbn As String) As StructureResult
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Function DetectShisakuSekkeiBlockInstl(ByVal shisakuEventCode As String, ByVal buhinNo As String, ByVal buhinNoKbn As String) As StructureResult
        ...
        Private Function DetectShisakuSekkeiBlockInstlEventCopy(ByVal shisakuEventCode As String, ByVal buhinNo As String, ByVal buhinNoKbn As String) As StructureResult
        ...
        Private Function IsEqualKey(ByVal blockVo As TShisakuSekkeiBlockVo, ByVal instlVo As TShisakuSekkeiBlockInstlVo) As Boolean
            Return blockVo.ShisakuEventCode.Equals(instlVo.ShisakuEventCode) _
                   AndAlso blockVo.ShisakuBukaCode.Equals(instlVo.ShisakuBukaCode) _
                   AndAlso blockVo.ShisakuBlockNo.Equals(instlVo.ShisakuBlockNo) _
                   AndAlso blockVo.ShisakuBlockNoKaiteiNo.Equals(instlVo.ShisakuBlockNoKaiteiNo)
        End Function
        ...
        Private Function DetectShisakuBuhinEdit(ByVal buhinNo As String) As StructureResult
            Dim param As New TShisakuBuhinEditVo
            param.BuhinNo = buhinNo
            Dim instlVos3 As List(Of TShisakuBuhinEditVo) = editDao.FindBy(param)
            Dim editVos As New List(Of TShisakuBuhinEditVo)

            For Each editVo As TShisakuBuhinEditVo In instlVos3
                If IsEqualKey(blockKeyVo, editVo) Then
                    Continue For
                End If
                If Not StringUtil.IsEmpty(editVo.BuhinNoKbn) Then   ' Null値か、Empty値か、どっちが登録されているか不安なので、ここでフィルタする
                    Continue For
                End If
                editVos.Add(editVo)
            Next
        ...
        Private Function IsEqualKey(ByVal blockVo As TShisakuSekkeiBlockVo, ByVal instlVo As TShisakuBuhinEditVo) As Boolean
            Return blockVo.ShisakuEventCode.Equals(instlVo.ShisakuEventCode) _
                   AndAlso blockVo.ShisakuBukaCode.Equals(instlVo.ShisakuBukaCode) _
                   AndAlso blockVo.ShisakuBlockNo.Equals(instlVo.ShisakuBlockNo) _
                   AndAlso blockVo.ShisakuBlockNoKaiteiNo.Equals(instlVo.ShisakuBlockNoKaiteiNo)
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Private Class EditDescendingUpdated : Implements IComparer(Of TShisakuBuhinEditVo)

            Public Function Compare(ByVal x As TShisakuBuhinEditVo, ByVal y As TShisakuBuhinEditVo) As Integer Implements IComparer _
                                                                                                                   (Of TShisakuBuhinEditVo) _
                                                                                                                   .Compare
                Dim result As Integer = y.UpdatedDate.CompareTo(x.UpdatedDate)
                If result <> 0 Then
                    Return result
