...
Namespace ShisakuBuhinEdit.Kosei.Logic
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class BuhinKoseiRecordVo : Inherits TShisakuBuhinEditVo
        '' 圧縮フラグ  
        ...
        Public Function Clone() As BuhinKoseiRecordVo
            Return CType(MemberwiseClone(), BuhinKoseiRecordVo)
        End Function
