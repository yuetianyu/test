...
Namespace ShisakuBuhinEdit.Kosei.Logic.Matrix
    ...
    Public Class BuhinKoseiMatrix
        ...
        ''' <remarks></remarks>
        Public Sub New(ByVal editVos As List(Of TShisakuBuhinEditVo), ByVal editInstlVos As List(Of TShisakuBuhinEditInstlVo))
        ...
        ''' <remarks></remarks>
        Private Shared Function MakeInstlVosByHyojijun(ByVal editVos As List(Of TShisakuBuhinEditVo), ByVal editInstlVos As List(Of TShisakuBuhinEditInstlVo)) As Dictionary(Of Integer, List(Of TShisakuBuhinEditInstlVo))
        ...
        Public Function CopyByIndex(ByVal indexList As List(Of Integer)) As BuhinKoseiMatrix
            ...
            Dim result As New BuhinKoseiMatrix()
            Dim colList As List(Of Integer) = Me.GetInputInsuColumnIndexesByRowIndex(indexList)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function NewInnerJoinHyoujiJun(ByVal editVos As List(Of TShisakuBuhinEditVo), ByVal editInstlVos As List(Of TShisakuBuhinEditInstlVo)) As BuhinKoseiMatrix

            Dim instlVosByHyojijun As Dictionary(Of Integer, List(Of TShisakuBuhinEditInstlVo)) = MakeInstlVosByHyojijun(editVos, editInstlVos)
            Dim extractedEditVos As New List(Of TShisakuBuhinEditVo)
            For Each editVo As TShisakuBuhinEditVo In editVos
        ...
        Public Function GetParentRecord(ByVal rowIndex As Integer, ByVal columnIndex As Integer) As BuhinKoseiRecordVo
            ...
            If buhinKoseiRecordVo.Level = 0 Then
                Return Nothing
            End If
            Dim indexes As List(Of Integer) = GetInputRowIndexesOnColumn(columnIndex)
            For i As Integer = 1 To indexes.Count
                ...
                If rowIndex <= index Then
                    Continue For
                End If
                If Record(index).Level + 1 = buhinKoseiRecordVo.Level Then
                    Return Record(index)
                End If
            Next
            Return Nothing
