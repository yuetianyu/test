...
Namespace ShisakuBuhinEdit.Kosei.Logic.Matrix
    ...
    Public Class MakeStructureResultImpl
        ...
        ''' <returns>部品表</returns>
        ''' <remarks></remarks>
        Public Function Compute(ByVal aStructureResult As StructureResult, ByVal a0553flag As Integer, ByVal baseLevel As Integer?) As BuhinKoseiMatrix Implements MakeStructureResult.Compute
...
#If DEBUG Then
            'If StringUtil.Equals("57700CA050WU", aStructureResult.OriginalBuhinNo) Then
            '    Dim a As String = ""
            'End If
            'If StringUtil.Equals("57700CA050TT", aStructureResult.OriginalBuhinNo) Then
            '    Dim a As String = ""
            'End If
            'エラーが発生するブロック811B
#End If
        ...
        Private Function FindEditBy(ByVal blockInstlVo As TShisakuSekkeiBlockInstlVo) As List(Of TShisakuBuhinEditVo)
            'Dim param As New TShisakuBuhinEditVo
            'param.ShisakuEventCode = blockInstlVo.ShisakuEventCode
            'param.ShisakuBukaCode = blockInstlVo.ShisakuBukaCode
            'param.ShisakuBlockNo = blockInstlVo.ShisakuBlockNo
